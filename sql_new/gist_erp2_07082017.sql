...
--
-- Host: localhost    Database: gist_erp2
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `BOMDimension`;
...
CREATE TABLE `BOMDimension` (
  ...
  `shortcode` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_271AD9A85DA0FB8` (`template_id`),
  CONSTRAINT `FK_271AD9A85DA0FB8` FOREIGN KEY (`template_id`) REFERENCES `BOMTemplate` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BOMDimension`
--

LOCK TABLES `BOMDimension` WRITE;
/*!40000 ALTER TABLE `BOMDimension` DISABLE KEYS */;
/*!40000 ALTER TABLE `BOMDimension` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `BOMInput`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BOMInput` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bom_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `quantity` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_D0D4EC15BFD0DC92` (`bom_id`),
  KEY `IDX_D0D4EC154584665A` (`product_id`),
  CONSTRAINT `FK_D0D4EC154584665A` FOREIGN KEY (`product_id`) REFERENCES `inv_product` (`id`),
  CONSTRAINT `FK_D0D4EC15BFD0DC92` FOREIGN KEY (`bom_id`) REFERENCES `BillOfMaterial` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BOMInput`
--

LOCK TABLES `BOMInput` WRITE;
/*!40000 ALTER TABLE `BOMInput` DISABLE KEYS */;
/*!40000 ALTER TABLE `BOMInput` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `BOMMaterial`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BOMMaterial` (
  ...
  `formula` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_452561155DA0FB8` (`template_id`),
  KEY `IDX_452561154584665A` (`product_id`),
  CONSTRAINT `FK_452561154584665A` FOREIGN KEY (`product_id`) REFERENCES `inv_product` (`id`),
  CONSTRAINT `FK_452561155DA0FB8` FOREIGN KEY (`template_id`) REFERENCES `BOMTemplate` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BOMMaterial`
--

LOCK TABLES `BOMMaterial` WRITE;
/*!40000 ALTER TABLE `BOMMaterial` DISABLE KEYS */;
/*!40000 ALTER TABLE `BOMMaterial` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `BOMOutput`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BOMOutput` (
  ...
  `quantity` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_B9BC4BDCBFD0DC92` (`bom_id`),
  KEY `IDX_B9BC4BDC4584665A` (`product_id`),
  CONSTRAINT `FK_B9BC4BDC4584665A` FOREIGN KEY (`product_id`) REFERENCES `inv_product` (`id`),
  CONSTRAINT `FK_B9BC4BDCBFD0DC92` FOREIGN KEY (`bom_id`) REFERENCES `BillOfMaterial` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BOMOutput`
--

LOCK TABLES `BOMOutput` WRITE;
/*!40000 ALTER TABLE `BOMOutput` DISABLE KEYS */;
/*!40000 ALTER TABLE `BOMOutput` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `BOMTemplate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BOMTemplate` (
  ...
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `output_code` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `output_name` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `uom` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_AEFB0B0343C425D2` (`prodgroup_id`),
  CONSTRAINT `FK_AEFB0B0343C425D2` FOREIGN KEY (`prodgroup_id`) REFERENCES `inv_product_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BOMTemplate`
--

LOCK TABLES `BOMTemplate` WRITE;
/*!40000 ALTER TABLE `BOMTemplate` DISABLE KEYS */;
/*!40000 ALTER TABLE `BOMTemplate` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `acct_bank`
--

DROP TABLE IF EXISTS `acct_bank`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acct_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_9AFF07C2EEFE5067` (`user_create_id`),
  CONSTRAINT `FK_9AFF07C2EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acct_bank`
--

LOCK TABLES `acct_bank` WRITE;
/*!40000 ALTER TABLE `acct_bank` DISABLE KEYS */;
INSERT INTO `acct_bank` VALUES (1,NULL,'BDO','Active','2017-06-14 05:34:06'),(2,NULL,'RCBC','Active','2017-07-09 20:32:12'),(3,NULL,'BPI','Active','2017-07-09 20:32:27');
/*!40000 ALTER TABLE `acct_bank` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `acct_bank_account`
--

DROP TABLE IF EXISTS `acct_bank_account`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acct_bank_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_create_id` int(11) DEFAULT NULL,
  `name` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `date_create` datetime NOT NULL,
  `account_number` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `branch` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `currency` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `chart_of_account` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bank_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_8B285D60EEFE5067` (`user_create_id`),
  KEY `IDX_8B285D6011C8FB41` (`bank_id`),
  CONSTRAINT `FK_8B285D6011C8FB41` FOREIGN KEY (`bank_id`) REFERENCES `acct_bank` (`id`),
  CONSTRAINT `FK_8B285D60EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acct_bank_account`
--

LOCK TABLES `acct_bank_account` WRITE;
/*!40000 ALTER TABLE `acct_bank_account` DISABLE KEYS */;
INSERT INTO `acct_bank_account` VALUES (2,NULL,'Generic Bank X Account','Credit Card','2017-06-11 09:21:58','09839870333','Salcedo Makati Branch','PHP','','Active',1),(3,NULL,'RCBC Account 1','Savings','2017-07-09 20:33:14','00000809000','Main','PHP','','Active',2);
/*!40000 ALTER TABLE `acct_bank_account` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `acct_bank_charge`
--

DROP TABLE IF EXISTS `acct_bank_charge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acct_bank_charge` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bank_id` int(11) DEFAULT NULL,
  `user_create_id` int(11) DEFAULT NULL,
  `date_create` datetime NOT NULL,
  `rate_name` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `rate_value` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_F2463BE111C8FB41` (`bank_id`),
  KEY `IDX_F2463BE1EEFE5067` (`user_create_id`),
  CONSTRAINT `FK_F2463BE111C8FB41` FOREIGN KEY (`bank_id`) REFERENCES `acct_bank_account` (`id`),
  CONSTRAINT `FK_F2463BE1EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acct_bank_charge`
--

LOCK TABLES `acct_bank_charge` WRITE;
/*!40000 ALTER TABLE `acct_bank_charge` DISABLE KEYS */;
INSERT INTO `acct_bank_charge` VALUES (62,2,NULL,'2017-06-19 19:27:42','3 months','1.3'),(63,2,NULL,'2017-06-19 19:27:42','6 months','1.8'),(64,2,NULL,'2017-06-19 19:27:42','12 months','3'),(65,3,NULL,'2017-07-09 20:33:14','3 months','2.5');
/*!40000 ALTER TABLE `acct_bank_charge` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `acct_terminal`
--

DROP TABLE IF EXISTS `acct_terminal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acct_terminal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bank_account_id` int(11) DEFAULT NULL,
  `user_create_id` int(11) DEFAULT NULL,
  `terminal_of` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bank` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `payment_type` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mid` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tid` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `serial_number` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sim_card_number` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `date_create` datetime NOT NULL,
  `terminal_operator_id` int(11) DEFAULT NULL,
  `actual_location_id` int(11) DEFAULT NULL,
  `registered_location_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_F2FB6AF512CB990C` (`bank_account_id`),
  KEY `IDX_F2FB6AF5EEFE5067` (`user_create_id`),
  KEY `IDX_F2FB6AF5C5DA08BA` (`terminal_operator_id`),
  KEY `IDX_F2FB6AF5D7CF7E2A` (`actual_location_id`),
  KEY `IDX_F2FB6AF5C45BA2EF` (`registered_location_id`),
  CONSTRAINT `FK_F2FB6AF512CB990C` FOREIGN KEY (`bank_account_id`) REFERENCES `acct_bank_account` (`id`),
  CONSTRAINT `FK_F2FB6AF5C45BA2EF` FOREIGN KEY (`registered_location_id`) REFERENCES `loc_pos_locations` (`id`),
  CONSTRAINT `FK_F2FB6AF5C5DA08BA` FOREIGN KEY (`terminal_operator_id`) REFERENCES `acct_terminal_operator` (`id`),
  CONSTRAINT `FK_F2FB6AF5D7CF7E2A` FOREIGN KEY (`actual_location_id`) REFERENCES `loc_pos_locations` (`id`),
  CONSTRAINT `FK_F2FB6AF5EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acct_terminal`
--

LOCK TABLES `acct_terminal` WRITE;
/*!40000 ALTER TABLE `acct_terminal` DISABLE KEYS */;
INSERT INTO `acct_terminal` VALUES (1,2,NULL,'1','1','Rental','565765457','sdf','89789789','2343465735',NULL,NULL,'Active','sdf','2017-06-11 11:42:53',1,1,1),(2,2,NULL,'1','1','Quota','hgfhg','','','',NULL,NULL,'Active','','2017-07-05 22:46:08',1,4,4),(3,3,NULL,'2','2','Rental','00003246','ZKT-34HG34','23420000','09785674567',NULL,NULL,'Active','','2017-07-09 20:34:27',1,5,5);
/*!40000 ALTER TABLE `acct_terminal` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `acct_terminal_operator`
--

DROP TABLE IF EXISTS `acct_terminal_operator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acct_terminal_operator` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_create_id` int(11) DEFAULT NULL,
  `name` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `date_create` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_5A0F0E76EEFE5067` (`user_create_id`),
  CONSTRAINT `FK_5A0F0E76EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acct_terminal_operator`
--

LOCK TABLES `acct_terminal_operator` WRITE;
/*!40000 ALTER TABLE `acct_terminal_operator` DISABLE KEYS */;
INSERT INTO `acct_terminal_operator` VALUES (1,NULL,'GHL','Active','2017-06-14 06:06:31'),(2,NULL,'Tangent','Active','2017-07-09 20:35:23');
/*!40000 ALTER TABLE `acct_terminal_operator` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cfg_entry` VALUES ('accounting_cash_voucher_type','cash_voucher'),('accounting_check_voucher_type','check_voucher'),('accounting_current_period','1'),('cat_color_bg_image','#1d4568'),('cat_color_header','#000000'),('cat_color_login','#1d4568'),('cat_color_primary','#2a6496'),('cat_color_secondary','#2a6496'),('cat_color_tertiary','#1d4568'),('catalyst_warehouse_equipment','3'),('catalyst_warehouse_main','4'),('catalyst_warehouse_production_tank','6'),('catalyst_warehouse_sales','5'),('catalyst_warehouse_stock_adjustment','5'),('fareast_def_mol_prod','16'),('gist_warehouse_stock_adjustment','5'),('zulu_acct_current_period','1');
...
INSERT INTO `hr_benefit` VALUES (1,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'SSS',NULL,'2017-05-08 22:18:48'),(2,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'PhilHealth',NULL,'2017-05-08 22:18:48'),(3,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'PAG-IBIG',NULL,'2017-05-08 22:18:48'),(4,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'Sick Leave',NULL,'2017-05-08 22:18:48'),(5,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'Vacation Leave',NULL,'2017-05-08 22:18:48'),(6,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:1:{i:1;s:6:\"Female\";}',NULL,'Maternity Leave',NULL,'2017-05-08 22:18:48'),(7,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:1:{i:0;s:4:\"Male\";}',NULL,'Paternity Leave',NULL,'2017-05-08 22:18:48'),(8,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'Parental Leave',NULL,'2017-05-08 22:18:48'),(9,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:1:{i:1;s:6:\"Female\";}',NULL,'Leave for VAWC',NULL,'2017-05-08 22:18:48'),(10,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Days','a:1:{i:0;s:6:\"Female\";}',NULL,'Special leave for women ',NULL,'2017-05-08 22:18:48'),(11,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'13th month Pay',NULL,'2017-05-08 22:18:48'),(12,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'Separation Pay',NULL,'2017-05-08 22:18:48'),(13,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'ECOLA',NULL,'2017-05-08 22:18:48'),(14,1,'a:2:{i:1;s:12:\"Probationary\";i:3;s:7:\"Regular\";}','Quantified by Monetary Value','a:2:{i:0;s:4:\"Male\";i:1;s:6:\"Female\";}',NULL,'Savings',NULL,'2017-05-08 22:18:48');
...
INSERT INTO `hr_checklist` VALUES (1,1,'NBI CLearance','2017-05-08 22:18:48',''),(2,1,'Police Clearance','2017-05-08 22:18:48',''),(3,1,'Brgy Clearance','2017-05-08 22:18:48',''),(4,1,'Medical','2017-05-08 22:18:48',''),(5,1,'Drug Test','2017-05-08 22:18:48',''),(6,1,'NSO Birth Certificate','2017-05-08 22:18:48',''),(7,1,'Birth Certificate of Dependents','2017-05-08 22:18:48',''),(8,1,'2x2 Picture','2017-05-08 22:18:48',''),(9,1,'Photocopy of SSS No','2017-05-08 22:18:48',''),(10,1,'Photocopy of Tin No','2017-05-08 22:18:48',''),(11,1,'Photocopy of Philhealth No','2017-05-08 22:18:48',''),(12,1,'Photocopy of Pag-ibig No','2017-05-08 22:18:48',''),(13,1,'Photocopy of Diploma','2017-05-08 22:18:48',''),(14,1,'BIR 2305 w/ stamp','2017-05-08 22:18:48',''),(15,1,'1905 w/ stamp','2017-05-08 22:18:48',''),(16,1,'1902 w/ stamp','2017-05-08 22:18:48',''),(17,1,'PMRF','2017-05-08 22:18:48',''),(18,1,'MDF','2017-05-08 22:18:48',''),(19,1,'SSS loan verification','2017-05-08 22:18:48',''),(20,1,'Photocopy of Certificate of Employement (COE)','2017-05-08 22:18:48',''),(21,1,'Photocopy of Clearance','2017-05-08 22:18:48',''),(22,1,'2316 of current year','2017-05-08 22:18:48','');
...
INSERT INTO `hr_department` VALUES (1,NULL,NULL,1,'2017-05-08 22:18:48','Management'),(2,NULL,NULL,1,'2017-05-08 22:18:48','Human Resource'),(3,NULL,NULL,1,'2017-05-08 22:18:48','Admin'),(4,NULL,NULL,1,'2017-05-08 22:18:48','Accounting/Finance'),(5,NULL,NULL,1,'2017-05-08 22:18:48','Marketing'),(6,NULL,NULL,1,'2017-05-08 22:18:48','Mechandising'),(7,NULL,NULL,1,'2017-05-08 22:18:48','Sales'),(8,NULL,NULL,1,'2017-05-08 22:18:48','Sales Monitoring'),(9,NULL,NULL,1,'2017-05-08 22:18:48','Purchasing'),(10,NULL,NULL,1,'2017-05-08 22:18:48','Logistic'),(11,NULL,NULL,1,'2017-05-08 22:18:48','Warehousing'),(12,NULL,NULL,1,'2017-05-08 22:18:48','Research and Development'),(13,NULL,NULL,1,'2017-05-08 22:18:48','Quality Assurance'),(14,NULL,NULL,1,'2017-05-08 22:18:48','Production');
...
INSERT INTO `hr_holiday` VALUES (1,1,'2015-01-01','Regular Holiday','New Year\'s Day','2017-05-08 22:18:48'),(2,1,'2015-01-02','Special Non-Working','Additional special non-working day','2017-05-08 22:18:48'),(3,1,'2015-02-19','Special Non-Working','Chinese New Year','2017-05-08 22:18:48'),(4,1,'2015-04-02','Regular Holiday','Maundy Thursday','2017-05-08 22:18:48'),(5,1,'2015-04-03','Regular Holiday','Good Friday','2017-05-08 22:18:48'),(6,1,'2015-04-04','Special Non-Working','Black Saturday','2017-05-08 22:18:48'),(7,1,'2015-04-09','Regular Holiday','Araw Ng Kagitingan','2017-05-08 22:18:48'),(8,1,'2015-05-01','Regular Holiday','Labor Day','2017-05-08 22:18:48'),(9,1,'2015-06-12','Regular Holiday','Independence Day','2017-05-08 22:18:48'),(10,1,'2015-08-21','Special Non-Working','Ninoy Aquino Day','2017-05-08 22:18:48'),(11,1,'2015-08-31','Regular Holiday','National Heroes Day','2017-05-08 22:18:48'),(12,1,'2015-11-01','Special Non-Working','All Saints Day','2017-05-08 22:18:48'),(13,1,'2015-11-30','Regular Holiday','Bonifacio Day','2017-05-08 22:18:48'),(14,1,'2015-12-24','Special Non-Working','Additional special non-working day','2017-05-08 22:18:48'),(15,1,'2015-12-25','Regular Holiday','Christmas Day','2017-05-08 22:18:48'),(16,1,'2015-12-30','Regular Holiday','Rizal Day','2017-05-08 22:18:48'),(17,1,'2015-12-31','Special Non-Working','Last day of the year','2017-05-08 22:18:48');
...
INSERT INTO `hr_job_level` VALUES (1,1,'Rank and File','2017-05-08 22:18:48'),(2,1,'Officer','2017-05-08 22:18:48'),(3,1,'Managerial','2017-05-08 22:18:48'),(4,1,'Executive','2017-05-08 22:18:48');
...
INSERT INTO `hr_job_title` VALUES (1,1,NULL,1,'Rank','President/CEO','','2017-05-08 22:18:48'),(2,1,NULL,1,'Rank','VP Operations','','2017-05-08 22:18:48'),(3,2,NULL,1,'Rank','HR Employee Relations Officer','','2017-05-08 22:18:48'),(4,2,NULL,1,'Rank','HR Compensation and Benefits Assistant','','2017-05-08 22:18:48'),(5,2,NULL,1,'Rank','HR Recruitment Assistant','','2017-05-08 22:18:48'),(6,3,NULL,1,'Rank','Admin Officer-in-Charge','','2017-05-08 22:18:48'),(7,3,NULL,1,'Rank','Admin Officer','','2017-05-08 22:18:48'),(8,3,NULL,1,'Rank','Admin Assistant','','2017-05-08 22:18:48'),(9,3,NULL,1,'Rank','IT/Technical Support Officer','','2017-05-08 22:18:48'),(10,3,NULL,1,'Rank','Document Controller Specialist','','2017-05-08 22:18:48'),(11,3,NULL,1,'Rank','Plant Admin','','2017-05-08 22:18:48'),(12,3,NULL,1,'Rank','Janitor/Maintenance','','2017-05-08 22:18:48'),(13,4,NULL,1,'Rank','Accounting Head','','2017-05-08 22:18:48'),(14,4,NULL,1,'Rank','Accounting Officer-in-Charge','','2017-05-08 22:18:48'),(15,4,NULL,1,'Rank','Accounting Assistant','','2017-05-08 22:18:48'),(16,4,NULL,1,'Rank','Account Receivable','','2017-05-08 22:18:48'),(17,4,NULL,1,'Rank','Account Receivable Staff','','2017-05-08 22:18:48'),(18,4,NULL,1,'Rank','Treasury Officer','','2017-05-08 22:18:48'),(19,5,NULL,1,'Rank','Trade Marketing Specialist (Key Accounts)','','2017-05-08 22:18:48'),(20,5,NULL,1,'Rank','Trade Marketing Specialist (Distributor)','','2017-05-08 22:18:48'),(21,5,NULL,1,'Rank','Brand Marketing Officer','','2017-05-08 22:18:48'),(22,5,NULL,1,'Rank','Graphic Artist','','2017-05-08 22:18:48'),(23,5,NULL,1,'Rank','Business Development Manager','','2017-05-08 22:18:48'),(24,6,NULL,1,'Rank','Merchandising Office-in-Charge','','2017-05-08 22:18:48'),(25,6,NULL,1,'Rank','Merchandising Operations Supervisor','','2017-05-08 22:18:48'),(26,6,NULL,1,'Rank','Merchandising Support Assistant','','2017-05-08 22:18:48'),(27,6,NULL,1,'Rank','Sales Commando','','2017-05-08 22:18:48'),(28,7,NULL,1,'Rank','National Sales Manager','','2017-05-08 22:18:48'),(29,7,NULL,1,'Rank','Sales Admin Assistant','','2017-05-08 22:18:48'),(30,7,NULL,1,'Rank','Junior Sales Manager','','2017-05-08 22:18:48'),(31,7,NULL,1,'Rank','Distributor Sales Specialist','','2017-05-08 22:18:48'),(32,7,NULL,1,'Rank','Key Account Specialist','','2017-05-08 22:18:48'),(33,7,NULL,1,'Rank','Channel Sales Supervisor','','2017-05-08 22:18:48'),(34,7,NULL,1,'Rank','Senior Accounts Specialist','','2017-05-08 22:18:48'),(35,8,NULL,1,'Rank','Sales Monitoring Officer-in-Charge','','2017-05-08 22:18:48'),(36,8,NULL,1,'Rank','Sales Monitoring Staff','','2017-05-08 22:18:48'),(37,9,NULL,1,'Rank','Purchasing Officer-in-Charge','','2017-05-08 22:18:48'),(38,10,NULL,1,'Rank','Logistic Officer-in-Charge','','2017-05-08 22:18:48'),(39,10,NULL,1,'Rank','Logistic Assistant','','2017-05-08 22:18:48'),(40,10,NULL,1,'Rank','Logistic Staff','','2017-05-08 22:18:48'),(41,10,NULL,1,'Rank','Delivery Driver','','2017-05-08 22:18:48'),(42,10,NULL,1,'Rank','Delivery Helper','','2017-05-08 22:18:48'),(43,11,NULL,1,'Rank','Warehousing Supervisor','','2017-05-08 22:18:48'),(44,11,NULL,1,'Rank','Warehousing Assistant','','2017-05-08 22:18:48'),(45,11,NULL,1,'Rank','Warehouseman','','2017-05-08 22:18:48'),(46,12,NULL,1,'Rank','R&D Junior Manager','','2017-05-08 22:18:48'),(47,12,NULL,1,'Rank','R&D Assistant','','2017-05-08 22:18:48'),(48,13,NULL,1,'Rank','Quality Assurance Specialist','','2017-05-08 22:18:48'),(49,13,NULL,1,'Rank','Quality Assurance Assistant','','2017-05-08 22:18:48'),(50,14,NULL,1,'Rank','Plant Operations Manager','','2017-05-08 22:18:48'),(51,14,NULL,1,'Rank','Production Officer','','2017-05-08 22:18:48'),(52,14,NULL,1,'Rank','Production Worker/Factory Worker','','2017-05-08 22:18:48');
...
INSERT INTO `hr_location` VALUES (1,1,NULL,'7th Floor Ortigas','2017-05-08 22:18:48'),(2,1,NULL,'15th Floor Ortigas','2017-05-08 22:18:48'),(3,1,NULL,'Valenzuela','2017-05-08 22:18:48'),(4,1,NULL,'Meycauyan, Bulacan','2017-05-08 22:18:48'),(5,1,NULL,'Cavite','2017-05-08 22:18:48');
...
INSERT INTO `hr_schedule` VALUES (1,1,'2015-04-14 08:30:00','2015-04-14 17:30:00','Monday','Saturday',30,60,NULL,NULL,'Merchandising, Sales and Marketing - Managerial','2017-05-08 22:18:48'),(2,1,'2015-04-14 08:30:00','2015-04-14 17:30:00','Monday','Saturday',15,60,NULL,NULL,'Merchandising, Sales and Marketing - Rank and File','2017-05-08 22:18:48'),(3,1,'2015-04-14 09:00:00','2015-04-14 18:00:00','Monday','Saturday',30,60,NULL,NULL,'Office Staff - Managerial','2017-05-08 22:18:48'),(4,1,'2015-04-14 09:00:00','2015-04-14 18:00:00','Monday','Saturday',15,60,NULL,NULL,'Office Staff - Rank and File','2017-05-08 22:18:48'),(5,1,'2015-04-14 07:00:00','2015-04-14 16:00:00','Monday','Saturday',30,60,NULL,NULL,'Production - Managerial','2017-05-08 22:18:48'),(6,1,'2015-04-14 07:00:00','2015-04-14 16:00:00','Monday','Saturday',15,60,NULL,NULL,'Production - Rank and File','2017-05-08 22:18:48'),(7,1,'2015-04-14 06:00:00','2015-04-14 15:00:00','Monday','Saturday',30,60,NULL,NULL,'Delivery - Managerial','2017-05-08 22:18:48'),(8,1,'2015-04-14 06:00:00','2015-04-14 15:00:00','Monday','Saturday',15,60,NULL,NULL,'Delivery - Rank and File','2017-05-08 22:18:48');
...
INSERT INTO `inv_account` VALUES (1,1,1,'2015-07-22 18:09:16','Warehouse: ss, '),(2,1,0,'2015-07-23 16:27:13','Warehouse: Test Customer'),(3,1,1,'2015-08-10 14:36:19','Supplier: , Test'),(4,1,0,'2015-08-10 15:14:49','Warehouse: Receiving Warehouse'),(5,1,0,'2016-02-04 19:08:16','Warehouse: Sales Warehouse'),(6,1,0,'2016-02-04 19:08:22','Warehouse: Equipment Warehouse');
...
INSERT INTO `inv_brand` VALUES (2,'Aqua Mineral'),(3,'Botanifique'),(4,'ELEVATIONE'),(5,'Generic');
...
INSERT INTO `inv_product` VALUES (6,'24K Intensive Face Cream','7~3',2,3,'267019001','839901003427',39,12.00,'USD',24900.00,12450.00,23.00,'2017-07-03 00:00:00','24K Intensive Face Cream','Remarkable Tightenex and enriching 24K gold, combine with added vitamin E in this luxuriously textured cream that can help boost the skin’s collagen for a firmer, more supple appearance. The ideal skin-supporting formula, complete with the antioxidan','Apply to cleansed, dry skin, morning and evening, and enjoy the supple skin sensation of golden nourishment.','2017-07-05 00:00:00',NULL,1),(7,'24K Intensive Face Serum',NULL,2,3,'83990100343','83990100343',42,16.00,'USD',27900.00,27000.00,0.00,'2017-07-02 00:00:00','','','','2017-07-02 00:00:00',NULL,1),(8,'24K Intensive Mask',NULL,2,3,'839901004783','839901004783',43,18.00,'USD',29900.00,15000.00,0.00,'2017-07-02 00:00:00','','','','2017-07-02 00:00:00',NULL,1),(9,'Blissful Body Butter - Springtime',NULL,2,3,'839901008019','839901008019',44,3.85,'USD',3800.00,1900.00,0.00,'2017-07-02 00:00:00','','','','2017-07-02 00:00:00',NULL,1),(10,'Body Lotion - Delicate Dew (Big)',NULL,2,4,'267022029','839901007982',47,1.90,'USD',2200.00,1100.00,0.00,'2017-07-09 00:00:00','Velvet Touch Hand&Body Lotion Delicate Dew','Based on moisturizing sesame seed oil, jojoba oil, olive oil, and avocado oil, the perfectly balanced formula contains restorative Dunaliella algae, Dead Sea minerals and Vitamin E that deeply nourish the skin, as well as invigorating ginseng and ros','Apply a small amount and massage into your skin until absorbed. For best results apply regularly after shower or bath, or anytime your skin needs a moisturizing lift.','2017-07-09 00:00:00',NULL,1);
...
INSERT INTO `inv_product_category` VALUES (3,'Anti Aging',2),(4,'Body Care',2),(5,'Facial Care',2),(6,'Hair',2),(7,'Kits',2),(8,'Mask & More',2),(9,'Optima+',2),(10,'Nail Care',2);
...
INSERT INTO `inv_product_type` VALUES (1,'Goods'),(2,'Consumables'),(3,'Fixed'),(4,'Package');
...
INSERT INTO `inv_supplier` VALUES (2,'Cosmetigorup Factory','cmp','','','','113-423-456','Supplies','2','2','Aleksis Corbi','423-1427','09989546125','932-4544','pini@cosmetigroup.com.ph','Active','www.generic.com'),(3,'AQUA RICH INC.','cmp','','','','000-000-000','Supplies','1','','','','','','','',''),(4,'Haia','cmp','','','','000-000-000','Manpower','1','','','0','','','','Active','');
...
INSERT INTO `inv_warehouse` VALUES (1,1,1,'',0,0,0,NULL,1,NULL,'physical','','','Receiving Warehouse','2015-08-10 15:14:49'),(2,1,2,'',1,0,1,NULL,0,NULL,'physical','','','Sales Warehouse','2016-02-04 19:08:16'),(3,1,3,'',1,0,0,0,0,NULL,'physical	','asd','213','Equipment Warehouse','2016-02-04 19:08:22'),(4,1,4,'',1,0,0,NULL,0,NULL,'physical','','','Main Warehouse','2016-02-04 19:08:54'),(5,1,5,'',1,0,0,0,0,NULL,'adjustment',NULL,NULL,'Adjustment Warehouse','2016-02-04 19:09:07'),(6,1,6,'',1,0,0,NULL,0,NULL,'tank',NULL,NULL,'Production Tank','2016-02-04 19:09:38');
...
INSERT INTO `leave_type` VALUES (1,NULL,'a:2:{s:4:\"Male\";s:4:\"Male\";s:6:\"Female\";s:6:\"Female\";}','a:1:{s:7:\"Regular\";s:7:\"Regular\";}',0,NULL,NULL,0,NULL,NULL,5,'per Year',12,'FULL',NULL,'2017-05-08 22:18:48','Service Incentive Leave','Government-mandated leave for employees that have rendered at least 1 year of service in the company'),(2,NULL,'a:2:{s:4:\"Male\";s:4:\"Male\";s:6:\"Female\";s:6:\"Female\";}','a:1:{s:7:\"Regular\";s:7:\"Regular\";}',1,1,'Yearly',1,100,8,12,'per Year',12,'NONE',NULL,'2017-05-08 22:18:48','Sick Leave','12 days of Leave for employees that are sick'),(3,NULL,'a:1:{s:4:\"Male\";s:4:\"Male\";}','a:1:{s:7:\"Regular\";s:7:\"Regular\";}',0,NULL,NULL,0,NULL,NULL,7,'per Request',6,'NONE',NULL,'2017-05-08 22:18:48','Paternity Leave','7 days of leave for Male employees during Birth or Miscarriage of Legitimate Spouse'),(4,NULL,'a:2:{s:4:\"Male\";s:4:\"Male\";s:6:\"Female\";s:6:\"Female\";}','a:2:{s:7:\"Regular\";s:7:\"Regular\";s:12:\"Probationary\";s:12:\"Probationary\";}',0,NULL,NULL,0,NULL,NULL,3,'per Request',6,'NONE',NULL,'2017-05-08 22:18:48','Bereavement','3 days of leave in the event of death of a family member.'),(5,NULL,'a:2:{s:4:\"Male\";s:4:\"Male\";s:6:\"Female\";s:6:\"Female\";}','a:2:{s:7:\"Regular\";s:7:\"Regular\";s:12:\"Probationary\";s:12:\"Probationary\";}',0,NULL,NULL,0,NULL,NULL,7,'per Year',12,'NONE',NULL,'2017-05-08 22:18:48','Solo Parent Leave','Persons who fall under the definition of solo parents and who have rendered service of at least one year are entitled to 7 working days of leave to attend to their parental duties.'),(6,NULL,'a:2:{s:4:\"Male\";s:4:\"Male\";s:6:\"Female\";s:6:\"Female\";}','a:2:{s:7:\"Regular\";s:7:\"Regular\";s:12:\"Probationary\";s:12:\"Probationary\";}',0,NULL,NULL,0,NULL,NULL,2,'per Request',6,'NONE',NULL,'2017-05-08 22:18:48','Calamity Leave','2 days of leave for employees that are directly affected by calamity (e.g. Fire, Flood, Typhoon)'),(7,NULL,'a:1:{s:6:\"Female\";s:6:\"Female\";}','a:2:{s:7:\"Regular\";s:7:\"Regular\";s:12:\"Probationary\";s:12:\"Probationary\";}',0,NULL,NULL,0,NULL,NULL,60,'per Request',6,'NONE',NULL,'2017-05-08 22:18:48','Magna Carta for Women','Leave for female employees who underwent surgery caused by gynecological disorders'),(8,NULL,'a:1:{s:6:\"Female\";s:6:\"Female\";}','a:2:{s:7:\"Regular\";s:7:\"Regular\";s:12:\"Probationary\";s:12:\"Probationary\";}',0,NULL,NULL,0,NULL,NULL,60,'per Request',6,'FULL',NULL,'2017-05-08 22:18:48','Maternity Leave (Normal Delivery)',''),(9,NULL,'a:1:{s:6:\"Female\";s:6:\"Female\";}','a:2:{s:7:\"Regular\";s:7:\"Regular\";s:12:\"Probationary\";s:12:\"Probationary\";}',0,NULL,NULL,0,NULL,NULL,78,'per Request',6,'FULL',NULL,'2017-05-08 22:18:48','Maternity Leave (Caesarian)','');
...
INSERT INTO `ledger_entry` VALUES (49,NULL,'104','2017-07-09 08:54:55',1,'Generic Entry');
...
CREATE TABLE `les` (
  ...
  `date_create` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_6F0A5432EEFE5067` (`user_create_id`),
  CONSTRAINT `FK_6F0A5432EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `loc_areas` VALUES (1,NULL,'Team Ira','2017-06-07 12:31:48'),(2,NULL,'Test Gerson','2017-07-03 22:06:03'),(3,NULL,'Team Paul','2017-07-05 22:44:42'),(4,NULL,'Botanifique - Shang','2017-07-09 20:22:20'),(5,NULL,'Team Roi','2017-07-09 20:31:26');
...
INSERT INTO `loc_pos_locations` VALUES (1,1,NULL,'SM Aura','SM','09909544425','56.45345 53.2345','2nd floor near Bench','Kiosk','Aqua Mineral','Taguig','1675','NCR','Philippines','Active','2017-06-07 12:34:14',19,20,NULL,41,22,21,'2019-06-19','1901-12-13','1901-12-28','1901-12-29','1901-12-26','1901-12-21','90.00','88','76.00','No','98.00','Test','123.00','456.00','62','Richard','Owner','09973347323','richard@owner.com','Moonlit Insurance','1901-12-04','345q231','DLE','DA','3456','7897',NULL),(2,1,NULL,'Greenbelt 1','GBELT','','67.56675, 56.44433','Near Grocery','Kiosk','Aqua Mineral','Makati','67.56675, 56.44433','67.56675, 56.44433','67.56675, 56.44433','Active','2017-07-03 22:00:05',NULL,NULL,NULL,NULL,NULL,NULL,'2017-07-03','2017-07-03','2017-07-03','2017-07-03','2017-07-03','2017-07-03','1234','','67000','1','0.00','','2134','56','4B','Richard Dale Umayan','X','4443333','dale3d4@gmail.com','','2017-07-03','','Richard Dale Umayan','X','','dale3d4@gmail.com',NULL),(3,2,NULL,'Test POS Location 07/03/2017','n/a','n/a','n/a','n/a','Shop in shop','Aqua Mineral','n/a','n/a','n/a','n/a','Active','2017-07-04 04:52:13',NULL,NULL,NULL,NULL,NULL,NULL,'2017-07-04','2017-07-04','2017-07-04','2017-07-04','2017-07-04','2017-07-04','34','','45000','','0.00','n/a','56','3132.34','n/a','n/a','n/a','n/a','n/a','n/a','2017-07-04','n/a','n/a','n/a','n/a','n/a',NULL),(4,2,NULL,'Test POS Location 07/05/2017','jg','g','hg','hg','Kiosk','Aqua Mineral','ojkk','hg','hg','hg','Active','2017-07-05 22:32:28',NULL,NULL,NULL,NULL,NULL,NULL,'2017-07-05','2017-07-05','2017-07-05','2017-07-05','2017-07-05','2017-07-05','','','7800','','','','','','','','','','','','2017-07-05','','','','','',NULL),(5,5,NULL,'(Davao) SM Lanang','Cosmetigroup Int\'l Corp.','09178668934','7.0988538,125.6308133','J.P. Laurel Ave, Lanang, Davao City, 8000 Davao de','Kiosk','Aqua Mineral','Davao','1','Davao','Philippines','Active','2017-07-09 20:31:03',NULL,NULL,NULL,NULL,NULL,NULL,'2017-07-09','2017-07-09','2017-07-09','2017-07-09','2017-07-09','2017-07-09','','','0','No','','','','','','','','','','','2017-07-09','','','','','',NULL);
...
INSERT INTO `log_entry` VALUES (1,1,'2017-05-13 00:16:38','cat_user_user_add','added User 3.','','{\"id\":3,\"username\":\"xxx\",\"email\":\"123@123.com\",\"enabled\":false,\"groups\":[]}'),(2,1,'2017-05-13 00:30:10','cat_user_user_add','added User 4.','','{\"id\":4,\"username\":\"rdfxl123\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(3,1,'2017-05-13 00:54:35','cat_user_user_update','updated User 4.','','{\"id\":4,\"username\":\"rdfxl123\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(4,1,'2017-05-13 07:03:40','cat_user_department_add','added Department 1.','','{\"id\":1,\"date_create\":\"2017-05-13 07:03:40\",\"user_create\":null}'),(5,1,'2017-05-13 07:06:51','cat_user_department_delete','deleted Department 1.','','{\"id\":1,\"date_create\":\"2017-05-13 07:03:40\",\"user_create\":null}'),(6,1,'2017-05-13 07:07:54','cat_user_department_add','added Department 2.','','{\"id\":2,\"date_create\":\"2017-05-13 07:07:54\",\"user_create\":null}'),(7,1,'2017-05-13 07:08:16','cat_user_department_update','updated Department 2.','','{\"id\":2,\"date_create\":\"2017-05-13 07:07:54\",\"user_create\":null}'),(8,1,'2017-05-13 07:10:15','cat_user_department_add','added Department 3.','','{\"id\":3,\"date_create\":\"2017-05-13 07:10:15\",\"user_create\":null}'),(9,1,'2017-05-13 07:20:19','cat_user_user_add','added User 5.','','{\"id\":5,\"username\":\"X123\",\"email\":\"1232222@123.com\",\"enabled\":false,\"groups\":[]}'),(10,1,'2017-05-13 07:26:02','cat_user_user_update','updated User 5.','','{\"id\":5,\"username\":\"X123\",\"email\":\"1232222@123.com\",\"enabled\":false,\"groups\":[]}'),(11,1,'2017-05-13 07:42:28','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_recruit.menu\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.review\":true,\"hris_requisition.reject\":true}}'),(12,1,'2017-05-13 07:43:49','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_recruit.menu\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.review\":true,\"hris_requisition.reject\":true}}'),(13,1,'2017-05-13 07:46:26','cat_user_group_update','updated Position 9.','','{\"id\":9,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_profile_employee.menu\":true,\"hris_profile_employee.edit\":true,\"hris_profile_request.menu\":true,\"hris_profile_request.add\":true,\"hris_profile_request.view\":true,\"hris_profile_request.edit\":true,\"hris_profile_request.delete\":true,\"hris_profile_leave.menu\":true,\"hris_profile_leave.add\":true,\"hris_profile_leave.view\":true,\"hris_profile_leave.edit\":true,\"hris_profile_leave.delete\":true,\"hris_profile_attendance.menu\":true,\"hris_profile_attendance.add\":true,\"hris_profile_attendance.view\":true,\"hris_profile_attendance.edit\":true,\"hris_profile_attendance.delete\":true}}'),(14,1,'2017-05-13 07:54:30','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(15,1,'2017-05-13 08:45:27','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_recruit.menu\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.review\":true,\"hris_requisition.reject\":true}}'),(16,1,'2017-05-13 08:47:38','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_recruit.menu\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.review\":true,\"hris_requisition.reject\":true}}'),(17,1,'2017-05-13 08:48:54','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_recruit.menu\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.review\":true,\"hris_requisition.reject\":true}}'),(18,1,'2017-05-13 08:50:10','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_memo.view\":true,\"hris_memo_company.view\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_violation.view\":true,\"hris_memo_promotion.view\":true,\"hris_memo_regularization.view\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_recruit.menu\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.review\":true,\"hris_requisition.reject\":true}}'),(19,1,'2017-05-13 08:52:33','cat_user_group_update','updated Position 8.','','{\"id\":8,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_incident.review\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.add\":true,\"hris_applications.edit\":true,\"hris_applications.delete\":true,\"hris_applications_edit_progress.view\":true,\"hris_applications_edit_progress.edit\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_profile_request.edit_coe\":true,\"hris_profile_request.save_coe\":true,\"hris_profile_request.print_coe\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(20,1,'2017-05-13 08:52:46','cat_user_group_update','updated Position 8.','','{\"id\":8,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_incident.review\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.add\":true,\"hris_applications.edit\":true,\"hris_applications.delete\":true,\"hris_applications_edit_progress.view\":true,\"hris_applications_edit_progress.edit\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_profile_request.edit_coe\":true,\"hris_profile_request.save_coe\":true,\"hris_profile_request.print_coe\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(21,1,'2017-05-13 08:53:44','cat_user_group_update','updated Position 8.','','{\"id\":8,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_incident.review\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.add\":true,\"hris_applications.edit\":true,\"hris_applications.delete\":true,\"hris_applications_edit_progress.view\":true,\"hris_applications_edit_progress.edit\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_profile_request.edit_coe\":true,\"hris_profile_request.save_coe\":true,\"hris_profile_request.print_coe\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(22,1,'2017-05-13 08:56:33','cat_user_group_update','updated Position 8.','','{\"id\":8,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_incident.review\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.add\":true,\"hris_applications.edit\":true,\"hris_applications.delete\":true,\"hris_applications_edit_progress.view\":true,\"hris_applications_edit_progress.edit\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_profile_request.edit_coe\":true,\"hris_profile_request.save_coe\":true,\"hris_profile_request.print_coe\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(23,1,'2017-05-13 09:17:04','cat_user_group_update','updated Position 11.','','{\"id\":11,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_user_user.menu\":true,\"cat_user_user.view\":true,\"cat_user_user.add\":true,\"cat_user_user.edit\":true,\"cat_user_user.delete\":true,\"cat_user_group.menu\":true,\"cat_user_group.view\":true,\"cat_user_group.add\":true,\"cat_user_group.edit\":true,\"cat_user_group.delete\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_biometrics.menu\":true,\"hris_biometrics.view\":true,\"hris_biometrics.add\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.edit\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.add\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.approve\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_incentive.delete\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_remuneration_loan.delete\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_workforce_reimbursement.delete\":true,\"hris_workforce_reimbursement.approve\":true,\"hris_workforce_reimbursement.reject\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications_edit_progress.view\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.approve\":true,\"hris_requisition.reject\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_employee.menu\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(24,1,'2017-05-14 19:48:43','cat_user_department_add','added Department 4.','','{\"id\":4,\"date_create\":\"2017-05-14 19:48:42\",\"user_create\":null}'),(25,1,'2017-05-14 19:49:16','cat_user_group_add','added Position 15.','','{\"id\":15,\"access\":{\"cat_dashboard.menu\":true,\"hris_dashboard.view\":true,\"hris_dashboard.edit\":true,\"hris_dashboard_admin.view\":true,\"hris_dashboard_request.view\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_user_user.menu\":true,\"cat_user_user.view\":true,\"cat_user_user.add\":true,\"cat_user_user.edit\":true,\"cat_user_user.delete\":true,\"cat_user_group.menu\":true,\"cat_user_group.view\":true,\"cat_user_group.add\":true,\"cat_user_group.edit\":true,\"cat_user_group.delete\":true}}'),(26,1,'2017-05-14 19:50:19','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(27,1,'2017-05-14 19:51:36','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(28,1,'2017-05-14 19:53:24','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(29,1,'2017-05-14 20:03:38','cat_user_group_update','updated Position 15.','','{\"id\":15,\"access\":{\"cat_dashboard.menu\":true,\"hris_dashboard.view\":true,\"hris_dashboard.edit\":true,\"hris_dashboard_admin.view\":true,\"hris_dashboard_request.view\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_user_user.menu\":true,\"cat_user_user.view\":true,\"cat_user_user.add\":true,\"cat_user_user.edit\":true,\"cat_user_user.delete\":true,\"cat_user_group.menu\":true,\"cat_user_group.view\":true,\"cat_user_group.add\":true,\"cat_user_group.edit\":true,\"cat_user_group.delete\":true,\"cat_user_department.menu\":true,\"cat_user_department.view\":true,\"cat_user_department.add\":true,\"cat_user_department.edit\":true,\"cat_user_department.delete\":true}}'),(30,1,'2017-05-14 20:03:54','cat_user_department_add','added Department 5.','','{\"id\":5,\"date_create\":\"2017-05-14 20:03:54\",\"user_create\":null}'),(31,1,'2017-05-14 20:04:19','cat_user_group_add','added Position 16.','','{\"id\":16,\"access\":{\"cat_dashboard.menu\":true,\"hris_dashboard.view\":true,\"hris_dashboard.edit\":true,\"hris_dashboard_admin.view\":true,\"hris_dashboard_request.view\":true}}'),(32,1,'2017-05-14 20:05:20','cat_user_user_add','added User 6.','','{\"id\":6,\"username\":\"prinsipe_k\",\"email\":\"prinsipek@frogs.com\",\"enabled\":false,\"groups\":[]}'),(33,1,'2017-05-14 20:05:33','cat_user_user_update','updated User 6.','','{\"id\":6,\"username\":\"prinsipe_k\",\"email\":\"prinsipek@frogs.com\",\"enabled\":true,\"groups\":[]}'),(34,1,'2017-05-14 20:23:37','cat_user_group_update','updated Position 10.','','{\"id\":10,\"access\":[]}'),(35,1,'2017-05-15 17:24:47','cat_user_group_add','added Position 17.','','{\"id\":17,\"access\":[]}'),(36,1,'2017-05-15 17:25:11','cat_user_department_add','added Department 6.','','{\"id\":6,\"date_create\":\"2017-05-15 17:25:11\",\"user_create\":null}'),(37,1,'2017-05-15 17:30:49','cat_inv_brand_add','added Brand 1.','','{\"id\":1,\"name\":\"x\"}'),(38,1,'2017-05-15 17:40:03','cat_inv_product_category_add','added Product Category 1.','','{\"id\":1,\"name\":\"ddd\"}'),(39,1,'2017-05-16 21:33:21','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(40,1,'2017-05-16 23:22:00','cat_user_user_add','added User 7.','','{\"id\":7,\"username\":\"admin2\",\"email\":\"sdf@3333d.n\",\"enabled\":true,\"groups\":[]}'),(41,1,'2017-05-16 23:29:12','cat_user_user_update','updated User 7.','','{\"id\":7,\"username\":\"admin2\",\"email\":\"sdf@3333d.n\",\"enabled\":true,\"groups\":[]}'),(42,1,'2017-05-16 23:35:22','cat_user_user_update','updated User 7.','','{\"id\":7,\"username\":\"admin2\",\"email\":\"sdf@3333d.n\",\"enabled\":true,\"groups\":[]}'),(43,1,'2017-05-16 23:35:30','cat_user_user_update','updated User 7.','','{\"id\":7,\"username\":\"admin2\",\"email\":\"sdf@3333d.n\",\"enabled\":true,\"groups\":[]}'),(44,1,'2017-05-16 23:40:03','cat_user_user_update','updated User 7.','','{\"id\":7,\"username\":\"admin2\",\"email\":\"sdf@3333d.n\",\"enabled\":true,\"groups\":[]}'),(45,1,'2017-05-17 00:51:02','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(46,1,'2017-05-17 01:17:52','cat_user_user_add','added User 8.','','{\"id\":8,\"username\":\"admin556\",\"email\":\"dfg@sdf3.h\",\"enabled\":false,\"groups\":[]}'),(47,1,'2017-05-17 01:18:31','cat_user_user_add','added User 10.','','{\"id\":10,\"username\":\"admin324234\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(48,1,'2017-05-17 01:20:16','cat_user_user_add','added User 11.','','{\"id\":11,\"username\":\"123\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(49,1,'2017-05-20 16:04:13','cat_user_user_update','updated User 11.','','{\"id\":11,\"username\":\"123\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(50,1,'2017-05-20 16:04:19','cat_user_user_update','updated User 11.','','{\"id\":11,\"username\":\"123\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(51,1,'2017-05-20 16:04:41','cat_user_user_update','updated User 11.','','{\"id\":11,\"username\":\"123\",\"email\":\"\",\"enabled\":false,\"groups\":[]}'),(52,1,'2017-05-20 16:13:29','cat_user_items_list_add','added Item 1.','','{\"id\":1,\"date_create\":\"2017-05-20 16:13:29\",\"user_create\":null}'),(53,1,'2017-05-20 16:14:03','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(54,1,'2017-05-20 16:14:10','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"test@test.com\",\"enabled\":true,\"groups\":[]}'),(55,1,'2017-05-20 16:39:36','cat_user_items_list_add','added Item 2.','','{\"id\":2,\"date_create\":\"2017-05-20 16:39:36\",\"user_create\":null}'),(56,1,'2017-05-20 16:39:49','cat_user_items_list_add','added Item 3.','','{\"id\":3,\"date_create\":\"2017-05-20 16:39:49\",\"user_create\":null}'),(57,1,'2017-05-21 07:54:37','cat_user_group_delete','deleted Position 17.','','{\"id\":17,\"access\":[]}'),(58,1,'2017-05-21 07:54:43','cat_user_group_delete','deleted Position 11.','','{\"id\":11,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_user_user.menu\":true,\"cat_user_user.view\":true,\"cat_user_user.add\":true,\"cat_user_user.edit\":true,\"cat_user_user.delete\":true,\"cat_user_group.menu\":true,\"cat_user_group.view\":true,\"cat_user_group.add\":true,\"cat_user_group.edit\":true,\"cat_user_group.delete\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_biometrics.menu\":true,\"hris_biometrics.view\":true,\"hris_biometrics.add\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.edit\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.add\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.approve\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_incentive.delete\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_remuneration_loan.delete\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_workforce_reimbursement.delete\":true,\"hris_workforce_reimbursement.approve\":true,\"hris_workforce_reimbursement.reject\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications_edit_progress.view\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_requisition.approve\":true,\"hris_requisition.reject\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_employee.menu\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(59,1,'2017-05-21 07:54:54','cat_user_group_delete','deleted Position 12.','','{\"id\":12,\"access\":{\"cat_dashboard.menu\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.approve\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.view\":true,\"hris_cash.menu\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.add\":true,\"hris_applications.edit\":true,\"hris_applications.delete\":true,\"hris_applications_edit_progress.view\":true,\"hris_applications_edit_progress.edit\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true}}'),(60,1,'2017-05-21 07:54:58','cat_user_group_delete','deleted Position 14.','','{\"id\":14,\"access\":{\"cat_dashboard.menu\":true,\"hris_admin.menu\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.edit\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_appraisals.create\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_incident.review\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_cash.menu\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.edit\":true}}'),(61,1,'2017-05-21 07:55:02','cat_user_group_delete','deleted Position 13.','','{\"id\":13,\"access\":{\"cat_dashboard.menu\":true,\"hris_admin.menu\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_workforce_reimbursement.review\":true,\"hris_workforce_reimbursement.approve\":true,\"hris_workforce_reimbursement.reject\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true}}'),(62,1,'2017-05-21 07:55:07','cat_user_group_delete','deleted Position 8.','','{\"id\":8,\"access\":{\"cat_dashboard.menu\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"cat_admin.menu\":true,\"hris_omnibar.view\":true,\"hris_admin.menu\":true,\"hris_admin_department.menu\":true,\"hris_admin_department.view\":true,\"hris_admin_department.add\":true,\"hris_admin_department.edit\":true,\"hris_admin_department.delete\":true,\"hris_admin_events.menu\":true,\"hris_admin_events.view\":true,\"hris_admin_events.add\":true,\"hris_admin_events.edit\":true,\"hris_admin_events.delete\":true,\"hris_admin_jobtitles.menu\":true,\"hris_admin_jobtitles.view\":true,\"hris_admin_jobtitles.add\":true,\"hris_admin_jobtitles.edit\":true,\"hris_admin_jobtitles.delete\":true,\"hris_admin_joblevel.menu\":true,\"hris_admin_joblevel.view\":true,\"hris_admin_joblevel.add\":true,\"hris_admin_joblevel.edit\":true,\"hris_admin_joblevel.delete\":true,\"hris_admin_location.menu\":true,\"hris_admin_location.view\":true,\"hris_admin_location.add\":true,\"hris_admin_location.edit\":true,\"hris_admin_location.delete\":true,\"hris_admin_benefit.menu\":true,\"hris_admin_benefit.view\":true,\"hris_admin_benefit.add\":true,\"hris_admin_benefit.edit\":true,\"hris_admin_benefit.delete\":true,\"hris_admin_schedules.menu\":true,\"hris_admin_schedules.view\":true,\"hris_admin_schedules.add\":true,\"hris_admin_schedules.edit\":true,\"hris_admin_schedules. delete\":true,\"hris_admin_checklist.menu\":true,\"hris_admin_checklist.view\":true,\"hris_admin_checklist.add\":true,\"hris_admin_checklist.edit\":true,\"hris_admin_checklist.delete\":true,\"hris_admin_holiday.menu\":true,\"hris_admin_holiday.view\":true,\"hris_admin_holiday.add\":true,\"hris_admin_holiday.edit\":true,\"hris_admin_holiday.delete\":true,\"hris_admin_downloadables.menu\":true,\"hris_admin_downloadables.view\":true,\"hris_admin_downloadables.add\":true,\"hris_admin_downloadables.edit\":true,\"hris_admin_downloadables.delete\":true,\"hris_admin_leave.menu\":true,\"hris_admin_leave_type.menu\":true,\"hris_admin_leave_type.view\":true,\"hris_admin_leave_type.add\":true,\"hris_admin_leave_type.edit\":true,\"hris_admin_leave_type.delete\":true,\"hris_admin_leave_rules.menu\":true,\"hris_admin_leave_rules.view\":true,\"hris_admin_leave_rules.add\":true,\"hris_admin_leave_rules.edit\":true,\"hris_admin_leave_rules.delete\":true,\"hris_admin_appraisal_settings.menu\":true,\"hris_admin_appraisal_settings.view\":true,\"hris_admin_appraisal_settings.add\":true,\"hris_admin_appraisal_settings.edit\":true,\"hris_admin_appraisal_settings.delete\":true,\"hris_admin_otsetting.menu\":true,\"hris_admin_otsetting.edit\":true,\"hris_admin_form_codes.menu\":true,\"hris_admin_form_codes.view\":true,\"hris_admin_form_codes.edit\":true,\"hris_workforce.menu\":true,\"hris_workforce_employee.menu\":true,\"hris_workforce_employee.view\":true,\"hris_workforce_employee.add\":true,\"hris_workforce_employee.edit\":true,\"hris_workforce_attendance.menu\":true,\"hris_workforce_attendance.view\":true,\"hris_workforce_attendance.review\":true,\"hris_workforce_attendance.approve\":true,\"hris_workforce_attendance.reject\":true,\"hris_workforce_leave.menu\":true,\"hris_workforce_leave.view\":true,\"hris_workforce_leave.edit\":true,\"hris_workforce_leave.reject\":true,\"hris_workforce_leave.review\":true,\"hris_workforce_appraisals.menu\":true,\"hris_workforce_appraisals.view\":true,\"hris_workforce_appraisals.add\":true,\"hris_workforce_appraisals.edit\":true,\"hris_workforce_appraisals.delete\":true,\"hris_workforce_appraisals.evaluate\":true,\"hris_workforce_issued_property.menu\":true,\"hris_workforce_issued_property.view\":true,\"hris_workforce_issued_property.add\":true,\"hris_workforce_issued_property.edit\":true,\"hris_memo.menu\":true,\"hris_memo.view\":true,\"hris_memo.add\":true,\"hris_memo.edit\":true,\"hris_memo_company.menu\":true,\"hris_memo_company.view\":true,\"hris_memo_company.add\":true,\"hris_memo_company.edit\":true,\"hris_memo_disciplinary.menu\":true,\"hris_memo_disciplinary.view\":true,\"hris_memo_disciplinary.add\":true,\"hris_memo_disciplinary.edit\":true,\"hris_memo_tardiness.menu\":true,\"hris_memo_tardiness.view\":true,\"hris_memo_tardiness.add\":true,\"hris_memo_tardiness.edit\":true,\"hris_memo_violation.menu\":true,\"hris_memo_violation.view\":true,\"hris_memo_violation.add\":true,\"hris_memo_violation.edit\":true,\"hris_memo_promotion.menu\":true,\"hris_memo_promotion.view\":true,\"hris_memo_promotion.add\":true,\"hris_memo_promotion.edit\":true,\"hris_memo_regularization.menu\":true,\"hris_memo_regularization.view\":true,\"hris_memo_regularization.add\":true,\"hris_memo_regularization.edit\":true,\"hris_workforce_incident.menu\":true,\"hris_workforce_incident.view\":true,\"hris_workforce_incident.add\":true,\"hris_workforce_incident.edit\":true,\"hris_workforce_incident.review\":true,\"hris_workforce_resign.menu\":true,\"hris_workforce_resign.edit\":true,\"hris_workforce_resign.view\":true,\"hris_workforce_overtime.menu\":true,\"hris_workforce_overtime.view\":true,\"hris_workforce_overtime.edit\":true,\"hris_cash.menu\":true,\"hris_remuneration_incentive.menu\":true,\"hris_remuneration_incentive.view\":true,\"hris_remuneration_incentive.add\":true,\"hris_remuneration_incentive.edit\":true,\"hris_remuneration_loan.menu\":true,\"hris_remuneration_loan.view\":true,\"hris_remuneration_loan.add\":true,\"hris_remuneration_loan.edit\":true,\"hris_workforce_reimbursement.menu\":true,\"hris_workforce_reimbursement.view\":true,\"hris_workforce_reimbursement.add\":true,\"hris_workforce_reimbursement.edit\":true,\"hris_remuneration_cashbond.menu\":true,\"hris_remuneration_cashbond.view\":true,\"hris_remuneration_cashbond.add\":true,\"hris_remuneration_cashbond.edit\":true,\"hris_recruit.menu\":true,\"hris_applications.menu\":true,\"hris_applications.view\":true,\"hris_applications.add\":true,\"hris_applications.edit\":true,\"hris_applications.delete\":true,\"hris_applications_edit_progress.view\":true,\"hris_applications_edit_progress.edit\":true,\"hris_requisition.menu\":true,\"hris_requisition.view\":true,\"hris_requisition.add\":true,\"hris_requisition.edit\":true,\"hris_requisition.delete\":true,\"hris_com_overview.menu\":true,\"hris_com_info.menu\":true,\"hris_com_info.view\":true,\"hris_com_info.add\":true,\"hris_com_orgchart.menu\":true,\"hris_com_orgchart.view\":true,\"hris_com_directory.menu\":true,\"hris_com_directory.view\":true,\"hris_payroll.menu\":true,\"hris_payroll_setting.menu\":true,\"hris_payroll_sss.menu\":true,\"hris_payroll_sss.view\":true,\"hris_payroll_sss.add\":true,\"hris_payroll_sss.edit\":true,\"hris_payroll_sss.delete\":true,\"hris_payroll_philhealth.menu\":true,\"hris_payroll_philhealth.view\":true,\"hris_payroll_philhealth.add\":true,\"hris_payroll_philhealth.edit\":true,\"hris_payroll_philhealth.delete\":true,\"hris_payroll_tax.menu\":true,\"hris_payroll_tax.view\":true,\"hris_payroll_tax.add\":true,\"hris_payroll_tax.edit\":true,\"hris_payroll_tax.delete\":true,\"hris_payroll_weekly.menu\":true,\"hris_payroll_semimonthly.menu\":true,\"hris_payroll_generate.menu\":true,\"hris_payroll_generate.view\":true,\"hris_payroll_weekly_generate.menu\":true,\"hris_payroll_weekly_generate.view\":true,\"hris_payroll_review.menu\":true,\"hris_payroll_review.view\":true,\"hris_payroll_view.menu\":true,\"hris_payroll_view.view\":true,\"hris_payroll_view.details\":true,\"hris_payroll_thirteenth.menu\":true,\"hris_payroll_thirteenth.view\":true,\"hris_payroll_thirteenth_view.menu\":true,\"hris_payroll_thirteenth_view.view\":true,\"hris_payroll_thirteenth_view.details\":true,\"hris_payroll_setting_min.menu\":true,\"hris_payroll_setting_min.edit\":true,\"hris_profile_request.approve\":true,\"hris_profile_request.reject\":true,\"hris_profile_request.edit_coe\":true,\"hris_profile_request.save_coe\":true,\"hris_profile_request.print_coe\":true,\"hris_report.menu\":true,\"hris_report_leave.menu\":true,\"hris_report_leave.view\":true,\"hris_report_attendance.menu\":true,\"hris_report_attendance.view\":true,\"hris_report_reimbursement.menu\":true,\"hris_report_reimbursement.view\":true,\"hris_report_regulars.menu\":true,\"hris_report_regulars.view\":true,\"hris_report_total_expense.menu\":true,\"hris_report_total_expense.view\":true,\"hris_report_turnover.menu\":true,\"hris_report_turnover.view\":true,\"hris_report_loans.menu\":true,\"hris_report_loans.view\":true,\"hris_report_incentives.menu\":true,\"hris_report_incentives.view\":true,\"hris_report_evals.menu\":true,\"hris_report_evals.view\":true,\"hris_report_payroll.menu\":true,\"hris_report_payroll.view\":true}}'),(63,1,'2017-05-21 07:55:11','cat_user_group_delete','deleted Position 10.','','{\"id\":10,\"access\":{\"cat_dashboard.menu\":true}}'),(64,1,'2017-05-21 07:58:43','cat_user_user_delete','deleted User 3.','','{\"id\":3,\"username\":\"xxx\",\"email\":\"123@123.com\",\"enabled\":false,\"groups\":[]}'),(65,1,'2017-05-21 07:58:49','cat_user_user_delete','deleted User 5.','','{\"id\":5,\"username\":\"X123\",\"email\":\"1232222@123.com\",\"enabled\":false,\"groups\":[]}'),(66,1,'2017-05-21 08:01:17','cat_user_group_add','added Position 18.','','{\"id\":18,\"access\":[]}'),(67,1,'2017-05-21 08:01:49','cat_user_department_delete','deleted Department 6.','','{\"id\":6,\"date_create\":\"2017-05-15 17:25:11\",\"user_create\":null}'),(68,1,'2017-05-21 08:01:54','cat_user_department_delete','deleted Department 5.','','{\"id\":5,\"date_create\":\"2017-05-14 20:03:54\",\"user_create\":null}'),(69,1,'2017-05-21 08:05:26','cat_user_user_add','added User 12.','','{\"id\":12,\"username\":\"hr_admin\",\"email\":\"vgelmo@test.com\",\"enabled\":true,\"groups\":[]}'),(70,1,'2017-05-21 08:05:48','cat_user_items_list_delete','deleted Item 1.','','{\"id\":1,\"date_create\":\"2017-05-20 16:13:29\",\"user_create\":null}'),(71,1,'2017-05-21 08:05:53','cat_user_items_list_delete','deleted Item 3.','','{\"id\":3,\"date_create\":\"2017-05-20 16:39:49\",\"user_create\":null}'),(72,1,'2017-05-21 08:05:57','cat_user_items_list_delete','deleted Item 2.','','{\"id\":2,\"date_create\":\"2017-05-20 16:39:36\",\"user_create\":null}'),(73,1,'2017-05-21 08:06:29','cat_user_items_list_add','added Item 4.','','{\"id\":4,\"date_create\":\"2017-05-21 08:06:29\",\"user_create\":null}'),(74,1,'2017-05-21 08:06:57','cat_user_items_list_add','added Item 5.','','{\"id\":5,\"date_create\":\"2017-05-21 08:06:57\",\"user_create\":null}'),(75,1,'2017-05-21 08:07:10','cat_user_items_list_add','added Item 6.','','{\"id\":6,\"date_create\":\"2017-05-21 08:07:10\",\"user_create\":null}'),(76,1,'2017-05-21 08:07:33','cat_user_items_list_add','added Item 7.','','{\"id\":7,\"date_create\":\"2017-05-21 08:07:33\",\"user_create\":null}'),(77,1,'2017-05-21 08:07:43','cat_user_items_list_add','added Item 8.','','{\"id\":8,\"date_create\":\"2017-05-21 08:07:43\",\"user_create\":null}'),(78,1,'2017-05-21 08:07:54','cat_user_items_list_add','added Item 9.','','{\"id\":9,\"date_create\":\"2017-05-21 08:07:54\",\"user_create\":null}'),(79,1,'2017-05-21 08:08:14','cat_user_items_list_add','added Item 10.','','{\"id\":10,\"date_create\":\"2017-05-21 08:08:13\",\"user_create\":null}'),(80,1,'2017-05-21 08:08:42','cat_user_items_list_add','added Item 11.','','{\"id\":11,\"date_create\":\"2017-05-21 08:08:42\",\"user_create\":null}'),(81,1,'2017-05-21 08:09:14','cat_user_items_list_add','added Item 12.','','{\"id\":12,\"date_create\":\"2017-05-21 08:09:14\",\"user_create\":null}'),(82,1,'2017-05-21 08:09:46','cat_user_items_list_add','added Item 13.','','{\"id\":13,\"date_create\":\"2017-05-21 08:09:46\",\"user_create\":null}'),(83,1,'2017-05-21 08:10:32','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(84,1,'2017-05-21 08:13:27','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(85,1,'2017-05-21 08:53:44','cat_inv_prod_add','added Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(86,1,'2017-05-21 09:11:21','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(87,1,'2017-05-21 09:39:04','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(88,1,'2017-05-21 09:39:11','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(89,1,'2017-05-21 09:39:39','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(90,1,'2017-05-21 09:42:53','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(91,1,'2017-05-21 09:46:11','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(92,1,'2017-05-21 09:51:41','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(93,1,'2017-05-21 09:51:47','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(94,1,'2017-05-21 09:54:35','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(95,1,'2017-05-21 09:55:12','cat_inv_prod_add','added Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(96,1,'2017-05-21 09:56:22','cat_inv_prod_add','added Product 3.','','{\"id\":3,\"name\":\"Sugar\"}'),(97,1,'2017-05-21 09:57:09','cat_inv_prod_add','added Product 4.','','{\"id\":4,\"name\":\"Timpladong Kape\"}'),(98,1,'2017-05-21 12:37:49','cat_inv_brand_add','added Brand 2.','','{\"id\":2,\"name\":\"Kapeng Barako\"}'),(99,1,'2017-05-21 12:37:58','cat_inv_brand_delete','deleted Brand 1.','','{\"id\":1,\"name\":\"x\"}'),(100,1,'2017-05-21 12:38:38','cat_inv_product_category_update','updated Product Category 1.','','{\"id\":1,\"name\":\"Food & Beverage\"}'),(101,1,'2017-05-21 12:40:36','cat_inv_prod_update','updated Product 4.','','{\"id\":4,\"name\":\"Timpladong Kape\"}'),(102,1,'2017-05-21 12:41:57','cat_inv_prod_add','added Product 5.','','{\"id\":5,\"name\":\"Matapang na Kape\"}'),(103,1,'2017-05-21 12:48:35','cat_inv_brand_add','added Brand 3.','','{\"id\":3,\"name\":\"XYZ Supplies\"}'),(104,1,'2017-05-21 12:48:58','cat_inv_product_category_add','added Product Category 2.','','{\"id\":2,\"name\":\"Raw Materials\"}'),(105,1,'2017-05-21 12:49:22','cat_inv_brand_update','updated Brand 2.','','{\"id\":2,\"name\":\"OurBrand\"}'),(106,1,'2017-05-21 12:49:44','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(107,1,'2017-05-21 12:51:21','cat_inv_prod_update','updated Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(108,1,'2017-05-21 12:51:42','cat_inv_prod_update','updated Product 3.','','{\"id\":3,\"name\":\"Sugar\"}'),(109,1,'2017-05-21 15:35:04','cat_inv_prod_update','updated Product 4.','','{\"id\":4,\"name\":\"Timpladong Kape\"}'),(110,1,'2017-05-28 07:20:18','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(111,1,'2017-05-28 07:34:36','cat_inv_prod_update','updated Product 4.','','{\"id\":4,\"name\":\"Timpladong Kape\"}'),(112,1,'2017-05-31 03:40:05','cat_inv_product_category_add','added Product Category 3.','','{\"id\":3,\"name\":\"x\"}'),(113,1,'2017-05-31 04:11:10','gist_loc_areas_add','added Areas 1.','','{\"id\":1,\"date_create\":\"2017-05-31 04:11:10\",\"user_create\":null}'),(114,1,'2017-05-31 04:11:32','gist_loc_areas_delete','deleted Areas 1.','','{\"id\":1,\"date_create\":\"2017-05-31 04:11:10\",\"user_create\":null}'),(115,1,'2017-05-31 04:12:09','gist_loc_areas_add','added Areas 2.','','{\"id\":2,\"date_create\":\"2017-05-31 04:12:08\",\"user_create\":null}'),(116,1,'2017-05-31 04:12:15','gist_loc_areas_delete','deleted Areas 2.','','{\"id\":2,\"date_create\":\"2017-05-31 04:12:08\",\"user_create\":null}'),(117,1,'2017-06-01 06:56:51','gist_loc_areas_add','added Area 3.','','{\"id\":3,\"date_create\":\"2017-06-01 06:56:51\",\"user_create\":null}'),(118,1,'2017-06-01 07:04:43','gist_loc_pos_locations_add','added POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-01 07:04:43\",\"user_create\":null}'),(119,1,'2017-06-01 07:13:09','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(120,1,'2017-06-01 07:55:39','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-01 07:04:43\",\"user_create\":null}'),(121,1,'2017-06-01 07:57:26','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-01 07:04:43\",\"user_create\":null}'),(122,1,'2017-06-01 08:30:33','gist_loc_pos_locations_add','added POS Location 2.','','{\"id\":2,\"date_create\":\"2017-06-01 08:30:33\",\"user_create\":null}'),(123,1,'2017-06-01 08:32:20','cat_user_department_update','updated Department 4.','','{\"id\":4,\"date_create\":\"2017-05-14 19:48:42\",\"user_create\":null}'),(124,1,'2017-06-01 08:32:32','cat_user_department_add','added Department 5.','','{\"id\":5,\"date_create\":\"2017-06-01 08:32:31\",\"user_create\":null}'),(125,1,'2017-06-01 08:32:42','cat_user_department_add','added Department 6.','','{\"id\":6,\"date_create\":\"2017-06-01 08:32:42\",\"user_create\":null}'),(126,1,'2017-06-01 08:32:53','cat_user_department_add','added Department 7.','','{\"id\":7,\"date_create\":\"2017-06-01 08:32:53\",\"user_create\":null}'),(127,1,'2017-06-01 08:33:05','cat_user_department_add','added Department 8.','','{\"id\":8,\"date_create\":\"2017-06-01 08:33:04\",\"user_create\":null}'),(128,1,'2017-06-01 08:34:39','cat_user_group_add','added Position 19.','','{\"id\":19,\"access\":[]}'),(129,1,'2017-06-01 08:35:10','cat_user_group_add','added Position 20.','','{\"id\":20,\"access\":[]}'),(130,1,'2017-06-01 08:35:50','cat_user_group_add','added Position 21.','','{\"id\":21,\"access\":[]}'),(131,1,'2017-06-01 08:36:20','cat_user_group_add','added Position 22.','','{\"id\":22,\"access\":[]}'),(132,1,'2017-06-01 08:36:49','gist_loc_areas_update','updated Area 3.','','{\"id\":3,\"date_create\":\"2017-06-01 06:56:51\",\"user_create\":null}'),(133,1,'2017-06-01 08:38:47','cat_user_user_add','added User 13.','','{\"id\":13,\"username\":\"ad13\",\"email\":\"aeb@generic.com\",\"enabled\":true,\"groups\":[]}'),(134,1,'2017-06-01 08:39:53','cat_user_user_add','added User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(135,1,'2017-06-01 08:40:52','cat_user_user_add','added User 15.','','{\"id\":15,\"username\":\"aborre\",\"email\":\"atb@generic.com\",\"enabled\":true,\"groups\":[]}'),(136,1,'2017-06-01 08:41:58','cat_user_user_update','updated User 1.','','{\"id\":1,\"username\":\"admin\",\"email\":\"sys_ad@test.com\",\"enabled\":true,\"groups\":[]}'),(137,1,'2017-06-01 09:01:18','cat_user_user_update','updated User 15.','','{\"id\":15,\"username\":\"aborre\",\"email\":\"atb@generic.com\",\"enabled\":true,\"groups\":[]}'),(138,1,'2017-06-01 09:08:50','cat_user_user_add','added User 16.','','{\"id\":16,\"username\":\"gaguilar\",\"email\":\"gga@generic.com\",\"enabled\":true,\"groups\":[]}'),(139,1,'2017-06-01 09:09:49','cat_user_user_update','updated User 16.','','{\"id\":16,\"username\":\"gaguilar\",\"email\":\"gga@generic.com\",\"enabled\":true,\"groups\":[]}'),(140,1,'2017-06-01 17:49:00','cat_inv_brand_update','updated Brand 2.','','{\"id\":2,\"name\":\"Aqua Mineral\"}'),(141,1,'2017-06-01 17:49:19','cat_inv_brand_update','updated Brand 3.','','{\"id\":3,\"name\":\"Botanifique\"}'),(142,1,'2017-06-01 17:49:35','cat_inv_brand_add','added Brand 4.','','{\"id\":4,\"name\":\"ELEVATIONE\"}'),(143,1,'2017-06-01 17:56:56','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(144,1,'2017-06-07 12:31:49','gist_loc_areas_add','added Area 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:31:48\",\"user_create\":null}'),(145,1,'2017-06-07 12:34:14','gist_loc_pos_locations_add','added POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(146,1,'2017-06-07 12:35:10','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(147,1,'2017-06-07 12:35:31','cat_user_user_update','updated User 15.','','{\"id\":15,\"username\":\"aborre\",\"email\":\"atb@generic.com\",\"enabled\":true,\"groups\":[]}'),(148,1,'2017-06-07 12:35:35','cat_user_user_update','updated User 13.','','{\"id\":13,\"username\":\"ad13\",\"email\":\"aeb@generic.com\",\"enabled\":true,\"groups\":[]}'),(149,1,'2017-06-07 12:35:42','cat_user_user_update','updated User 16.','','{\"id\":16,\"username\":\"gaguilar\",\"email\":\"gga@generic.com\",\"enabled\":true,\"groups\":[]}'),(150,1,'2017-06-11 08:59:45','gist_accounting_bank_accounts_add','added Bank Account 1.','','{\"id\":1,\"date_create\":\"2017-06-11 08:59:45\",\"user_create\":null}'),(151,1,'2017-06-11 08:59:54','gist_accounting_bank_accounts_delete','deleted Bank Account 1.','','{\"id\":1,\"date_create\":\"2017-06-11 08:59:45\",\"user_create\":null}'),(152,1,'2017-06-11 09:21:59','gist_accounting_bank_accounts_add','added Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(153,1,'2017-06-11 09:42:34','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(154,1,'2017-06-11 11:42:53','gist_terminals_terminal_add','added Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(155,1,'2017-06-11 11:48:08','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(156,1,'2017-06-11 11:52:26','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(157,1,'2017-06-11 11:54:09','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(158,1,'2017-06-11 11:57:39','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(159,1,'2017-06-11 11:58:13','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(160,1,'2017-06-11 12:08:04','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(161,1,'2017-06-11 12:10:22','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(162,1,'2017-06-11 12:11:14','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(163,1,'2017-06-11 12:11:37','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(164,1,'2017-06-11 13:16:25','cat_user_user_update','updated User 12.','','{\"id\":12,\"username\":\"hr_admin\",\"email\":\"vgelmo@test.com\",\"enabled\":true,\"groups\":[]}'),(165,1,'2017-06-11 13:16:33','cat_user_user_update','updated User 12.','','{\"id\":12,\"username\":\"hr_admin\",\"email\":\"vgelmo@test.com\",\"enabled\":true,\"groups\":[]}'),(166,1,'2017-06-11 13:17:12','cat_user_user_update','updated User 12.','','{\"id\":12,\"username\":\"hr_admin\",\"email\":\"vgelmo@test.com\",\"enabled\":true,\"groups\":[]}'),(167,1,'2017-06-11 13:17:18','cat_user_user_update','updated User 12.','','{\"id\":12,\"username\":\"hr_admin\",\"email\":\"vgelmo@test.com\",\"enabled\":true,\"groups\":[]}'),(168,1,'2017-06-14 05:34:06','gist_accounting_banks_add','added Bank 1.','','{\"id\":1,\"date_create\":\"2017-06-14 05:34:06\",\"user_create\":null}'),(169,1,'2017-06-14 05:44:12','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(170,1,'2017-06-14 06:01:37','gist_accounting_banks_update','updated Bank 1.','','{\"id\":1,\"date_create\":\"2017-06-14 05:34:06\",\"user_create\":null}'),(171,1,'2017-06-14 06:04:37','gist_terminals_terminal_operator_add','added Terminal Operator 2.','','{\"id\":2,\"date_create\":\"2017-06-14 06:04:37\",\"user_create\":null}'),(172,1,'2017-06-14 06:05:13','gist_accounting_banks_delete','deleted Bank 2.','','{\"id\":2,\"date_create\":\"2017-06-14 06:04:37\",\"user_create\":null}'),(173,1,'2017-06-14 06:06:31','gist_terminals_terminal_operator_add','added Terminal Operator 1.','','{\"id\":1,\"date_create\":\"2017-06-14 06:06:31\",\"user_create\":null}'),(174,1,'2017-06-14 22:52:01','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(175,1,'2017-06-17 16:49:33','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(176,1,'2017-06-17 16:51:11','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(177,1,'2017-06-17 16:55:57','gist_terminals_terminal_update','updated Terminal 1.','','{\"id\":1,\"date_create\":\"2017-06-11 11:42:53\",\"user_create\":null}'),(178,1,'2017-06-17 17:52:19','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(179,1,'2017-06-18 10:34:30','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(180,1,'2017-06-18 10:36:59','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(181,1,'2017-06-18 10:37:27','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(182,1,'2017-06-18 12:34:11','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(183,1,'2017-06-18 12:36:27','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(184,1,'2017-06-18 12:42:46','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(185,1,'2017-06-18 12:54:42','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(186,1,'2017-06-18 17:55:39','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(187,1,'2017-06-18 17:55:55','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(188,1,'2017-06-18 18:02:38','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(189,1,'2017-06-18 18:11:55','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(190,1,'2017-06-18 18:15:42','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(191,1,'2017-06-18 18:22:30','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(192,1,'2017-06-18 18:24:39','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(193,1,'2017-06-18 18:25:17','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(194,1,'2017-06-18 18:26:03','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(195,1,'2017-06-18 18:26:17','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(196,1,'2017-06-18 18:27:38','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(197,1,'2017-06-18 18:32:23','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(198,1,'2017-06-18 18:32:34','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(199,1,'2017-06-18 18:33:38','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(200,1,'2017-06-18 18:33:45','cat_inv_prod_update','updated Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(201,1,'2017-06-18 20:25:33','gist_supp_add','added Supplier 1.','','{\"id\":1,\"name\":\"asad\"}'),(202,1,'2017-06-18 20:25:41','gist_supp_delete','deleted Supplier 1.','','{\"id\":1,\"name\":\"asad\"}'),(203,1,'2017-06-18 20:45:06','gist_supp_add','added Supplier 2.','','{\"id\":2,\"name\":\"ABC Corp\"}'),(204,1,'2017-06-18 20:49:33','gist_supp_update','updated Supplier 2.','','{\"id\":2,\"name\":\"Gahza Corp\"}'),(205,1,'2017-06-18 20:49:48','cat_inv_prod_delete','deleted Product 2.','','{\"id\":2,\"name\":\"Coffee\"}'),(206,1,'2017-06-18 20:49:56','cat_inv_prod_delete','deleted Product 4.','','{\"id\":4,\"name\":\"Timpladong Kape\"}'),(207,1,'2017-06-18 20:50:06','cat_inv_prod_delete','deleted Product 1.','','{\"id\":1,\"name\":\"Milk\"}'),(208,1,'2017-06-18 20:50:14','cat_inv_prod_delete','deleted Product 3.','','{\"id\":3,\"name\":\"Sugar\"}'),(209,1,'2017-06-18 20:50:23','cat_inv_prod_delete','deleted Product 5.','','{\"id\":5,\"name\":\"Matapang na Kape\"}'),(210,1,'2017-06-18 20:51:37','cat_inv_prod_add','added Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(211,1,'2017-06-18 20:52:06','cat_inv_product_category_update','updated Product Category 3.','','{\"id\":3,\"name\":\"Goods\"}'),(212,1,'2017-06-18 20:52:58','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(213,1,'2017-06-18 20:53:23','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(214,1,'2017-06-19 18:31:08','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(215,1,'2017-06-19 18:34:06','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(216,1,'2017-06-19 18:34:37','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(217,1,'2017-06-19 18:39:27','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(218,1,'2017-06-19 18:39:34','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(219,1,'2017-06-19 18:39:47','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(220,1,'2017-06-19 18:40:28','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(221,1,'2017-06-19 18:40:35','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(222,1,'2017-06-19 19:06:25','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(223,1,'2017-06-19 19:07:15','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(224,1,'2017-06-19 19:07:23','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(225,1,'2017-06-19 19:08:40','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(226,1,'2017-06-19 19:08:55','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(227,1,'2017-06-19 19:17:56','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(228,1,'2017-06-19 19:18:08','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(229,1,'2017-06-19 19:18:19','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(230,1,'2017-06-19 19:18:27','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(231,1,'2017-06-19 19:21:33','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(232,1,'2017-06-19 19:22:16','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(233,1,'2017-06-19 19:22:58','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(234,1,'2017-06-19 19:23:43','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(235,1,'2017-06-19 19:24:30','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(236,1,'2017-06-19 19:26:24','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(237,1,'2017-06-19 19:27:06','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(238,1,'2017-06-19 19:27:42','gist_accounting_bank_accounts_update','updated Bank Account 2.','','{\"id\":2,\"date_create\":\"2017-06-11 09:21:58\",\"user_create\":null}'),(239,1,'2017-07-02 07:35:46','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(240,1,'2017-07-02 07:35:58','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(241,1,'2017-07-02 07:37:02','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(242,1,'2017-07-02 07:39:31','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(243,1,'2017-07-02 07:42:17','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(244,1,'2017-07-02 07:42:56','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(245,1,'2017-07-02 11:04:13','cat_inv_prod_add','added Product 7.','','{\"id\":7,\"name\":\"24K Intensive Face Serum\"}'),(246,1,'2017-07-02 11:07:07','cat_inv_prod_add','added Product 8.','','{\"id\":8,\"name\":\"24K Intensive Mask\"}'),(247,1,'2017-07-02 11:08:28','cat_inv_prod_add','added Product 9.','','{\"id\":9,\"name\":\"Blissful Body Butter - Springtime\"}'),(248,1,'2017-07-03 21:53:44','cat_user_group_add','added Position 23.','','{\"id\":23,\"access\":[]}'),(249,1,'2017-07-03 21:54:01','cat_user_group_add','added Position 24.','','{\"id\":24,\"access\":[]}'),(250,1,'2017-07-03 22:00:06','gist_loc_pos_locations_add','added POS Location 2.','','{\"id\":2,\"date_create\":\"2017-07-03 22:00:05\",\"user_create\":null}'),(251,1,'2017-07-03 22:03:10','gist_loc_pos_locations_update','updated POS Location 2.','','{\"id\":2,\"date_create\":\"2017-07-03 22:00:05\",\"user_create\":null}'),(252,1,'2017-07-03 22:05:20','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(253,1,'2017-07-03 22:06:03','gist_loc_areas_add','added Area 2.','','{\"id\":2,\"date_create\":\"2017-07-03 22:06:03\",\"user_create\":null}'),(254,1,'2017-07-03 22:06:23','gist_loc_areas_update','updated Area 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:31:48\",\"user_create\":null}'),(255,1,'2017-07-03 22:09:42','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(256,1,'2017-07-03 22:10:36','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(257,1,'2017-07-03 22:13:55','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(258,1,'2017-07-03 22:14:49','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(259,1,'2017-07-03 22:16:26','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(260,1,'2017-07-04 04:42:03','cat_inv_product_category_update','updated Product Category 3.','','{\"id\":3,\"name\":\"Anti Aging\"}'),(261,1,'2017-07-04 04:42:21','cat_inv_product_category_add','added Product Category 4.','','{\"id\":4,\"name\":\"Body Care\"}'),(262,1,'2017-07-04 04:42:36','cat_inv_product_category_add','added Product Category 5.','','{\"id\":5,\"name\":\"Facial Care\"}'),(263,1,'2017-07-04 04:42:52','cat_inv_product_category_add','added Product Category 6.','','{\"id\":6,\"name\":\"Hair\"}'),(264,1,'2017-07-04 04:43:05','cat_inv_product_category_add','added Product Category 7.','','{\"id\":7,\"name\":\"Kits\"}'),(265,1,'2017-07-04 04:43:24','cat_inv_product_category_add','added Product Category 8.','','{\"id\":8,\"name\":\"Mask & More\"}'),(266,1,'2017-07-04 04:44:17','gist_supp_update','updated Supplier 2.','','{\"id\":2,\"name\":\"Cosmetigorup Factory\"}'),(267,1,'2017-07-04 04:44:54','gist_supp_add','added Supplier 3.','','{\"id\":3,\"name\":\"AQUA RICH INC.\"}'),(268,1,'2017-07-04 04:47:24','cat_user_items_list_add','added Item 14.','','{\"id\":14,\"date_create\":\"2017-07-04 04:47:24\",\"user_create\":null}'),(269,1,'2017-07-04 04:48:13','cat_user_items_list_add','added Item 15.','','{\"id\":15,\"date_create\":\"2017-07-04 04:48:13\",\"user_create\":null}'),(270,1,'2017-07-04 04:48:58','gist_loc_areas_update','updated Area 2.','','{\"id\":2,\"date_create\":\"2017-07-03 22:06:03\",\"user_create\":null}'),(271,1,'2017-07-04 04:51:11','cat_user_user_add','added User 17.','','{\"id\":17,\"username\":\"test07032017\",\"email\":\"test07032017@test.com\",\"enabled\":true,\"groups\":[]}'),(272,1,'2017-07-04 04:52:14','gist_loc_pos_locations_add','added POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(273,1,'2017-07-04 04:53:29','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(274,1,'2017-07-04 04:53:41','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(275,1,'2017-07-04 04:53:56','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(276,1,'2017-07-04 04:54:12','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(277,1,'2017-07-04 04:56:12','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(278,1,'2017-07-04 04:56:21','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(279,1,'2017-07-04 04:56:47','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(280,1,'2017-07-04 05:01:29','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(281,1,'2017-07-04 05:01:38','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(282,1,'2017-07-04 05:01:49','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(283,1,'2017-07-04 05:01:59','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(284,1,'2017-07-04 05:02:11','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(285,1,'2017-07-04 05:02:20','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(286,1,'2017-07-04 05:02:29','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(287,1,'2017-07-04 05:05:54','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(288,1,'2017-07-04 05:06:07','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(289,1,'2017-07-04 05:06:21','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(290,1,'2017-07-04 05:06:29','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(291,1,'2017-07-04 05:06:51','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(292,1,'2017-07-04 05:07:02','gist_loc_pos_locations_update','updated POS Location 3.','','{\"id\":3,\"date_create\":\"2017-07-04 04:52:13\",\"user_create\":null}'),(293,1,'2017-07-05 22:06:20','cat_user_user_update','updated User 14.','','{\"id\":14,\"username\":\"abegail34\",\"email\":\"aac@generic.com\",\"enabled\":true,\"groups\":[]}'),(294,1,'2017-07-05 22:31:32','cat_user_group_add','added Position 25.','','{\"id\":25,\"access\":[]}'),(295,1,'2017-07-05 22:32:28','gist_loc_pos_locations_add','added POS Location 4.','','{\"id\":4,\"date_create\":\"2017-07-05 22:32:28\",\"user_create\":null}'),(296,1,'2017-07-05 22:34:09','gist_loc_pos_locations_update','updated POS Location 4.','','{\"id\":4,\"date_create\":\"2017-07-05 22:32:28\",\"user_create\":null}'),(297,1,'2017-07-05 22:44:43','gist_loc_areas_add','added Area 3.','','{\"id\":3,\"date_create\":\"2017-07-05 22:44:42\",\"user_create\":null}'),(298,1,'2017-07-05 22:46:09','gist_terminals_terminal_add','added Terminal 2.','','{\"id\":2,\"date_create\":\"2017-07-05 22:46:08\",\"user_create\":null}'),(299,1,'2017-07-09 08:55:48','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(300,1,'2017-07-09 08:56:14','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(301,1,'2017-07-09 08:56:38','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(302,1,'2017-07-09 08:57:02','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(303,1,'2017-07-09 08:58:46','gist_loc_pos_locations_update','updated POS Location 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:34:14\",\"user_create\":null}'),(304,1,'2017-07-09 08:59:03','gist_loc_pos_locations_delete','deleted POS Location 4.','','{\"id\":4,\"date_create\":\"2017-07-05 22:32:28\",\"user_create\":null}'),(305,1,'2017-07-09 09:52:37','cat_user_user_add','added User 18.','','{\"id\":18,\"username\":\"adminxxx\",\"email\":\"\",\"enabled\":true,\"groups\":[]}'),(306,1,'2017-07-09 09:53:08','cat_user_user_update','updated User 18.','','{\"id\":18,\"username\":\"adminxxx\",\"email\":\"abc@edf.com\",\"enabled\":true,\"groups\":[]}'),(307,1,'2017-07-09 13:09:58','cat_user_group_update','updated Position 15.','','{\"id\":15,\"access\":[]}'),(308,1,'2017-07-09 13:11:39','cat_user_group_delete','deleted Position 23.','','{\"id\":23,\"access\":[]}'),(309,1,'2017-07-09 13:12:06','cat_user_group_update','updated Position 23.','','{\"id\":23,\"access\":[]}'),(310,1,'2017-07-09 13:13:21','cat_user_group_update','updated Position 15.','','{\"id\":15,\"access\":{\"cat_dashboard.menu\":true,\"hris_dashboard.view\":true,\"hris_dashboard.edit\":true,\"hris_dashboard_admin.view\":true,\"hris_dashboard_request.view\":true,\"cat_config.menu\":true,\"cat_config.view\":true,\"cat_config.edit\":true,\"gist_accounting.menu\":true,\"gist_accounting_bank_accounts.menu\":true,\"gist_accounting_bank_accounts.view\":true,\"gist_accounting_bank_accounts.add\":true,\"gist_accounting_bank_accounts.edit\":true,\"gist_accounting_bank_accounts.delete\":true,\"gist_accounting_banks.menu\":true,\"gist_accounting_banks.view\":true,\"gist_accounting_banks.add\":true,\"gist_accounting_banks.edit\":true,\"gist_accounting_banks.delete\":true,\"gist_terminals.menu\":true,\"gist_terminals_terminal.menu\":true,\"gist_terminals_terminal.view\":true,\"gist_terminals_terminal.add\":true,\"gist_terminals_terminal.edit\":true,\"gist_terminals_terminal.delete\":true,\"gist_terminals_terminal_operator.menu\":true,\"gist_terminals_terminal_operator.view\":true,\"gist_terminals_terminal_operator.add\":true,\"gist_terminals_terminal_operator.edit\":true,\"gist_terminals_terminal_operator.delete\":true,\"gist_loc.menu\":true,\"gist_loc_areas.menu\":true,\"gist_loc_areas.view\":true,\"gist_loc_areas.add\":true,\"gist_loc_areas.edit\":true,\"gist_loc_areas.delete\":true,\"gist_loc_pos_locations.menu\":true,\"gist_loc_pos_locations.view\":true,\"gist_loc_pos_locations.add\":true,\"gist_loc_pos_locations.edit\":true,\"gist_loc_pos_locations.delete\":true,\"cat_hris.menu\":true,\"cat_user_user.menu\":true,\"cat_user_user.view\":true,\"cat_user_user.add\":true,\"cat_user_user.edit\":true,\"cat_user_user.delete\":true,\"cat_user_group.menu\":true,\"cat_user_group.view\":true,\"cat_user_group.add\":true,\"cat_user_group.edit\":true,\"cat_user_group.delete\":true,\"cat_user_department.menu\":true,\"cat_user_department.view\":true,\"cat_user_department.add\":true,\"cat_user_department.edit\":true,\"cat_user_department.delete\":true,\"cat_user_items_list.menu\":true,\"cat_user_items_list.view\":true,\"cat_user_items_list.add\":true,\"cat_user_items_list.edit\":true,\"cat_user_items_list.delete\":true,\"cat_inv.menu\":true,\"cat_inv_wh.menu\":true,\"cat_inv_wh.view\":true,\"cat_inv_wh.add\":true,\"cat_inv_wh.edit\":true,\"cat_inv_wh.delete\":true,\"cat_inv_brand.menu\":true,\"cat_inv_brand.view\":true,\"cat_inv_brand.add\":true,\"cat_inv_brand.edit\":true,\"cat_inv_brand.delete\":true,\"cat_inv_product_category.menu\":true,\"cat_inv_product_category.view\":true,\"cat_inv_product_category.add\":true,\"cat_inv_product_category.edit\":true,\"cat_inv_product_category.delete\":true,\"cat_inv_pg.menu\":true,\"cat_inv_pg.view\":true,\"cat_inv_pg.add\":true,\"cat_inv_pg.edit\":true,\"cat_inv_pg.delete\":true,\"cat_inv_prod.menu\":true,\"cat_inv_prod.view\":true,\"cat_inv_prod.add\":true,\"cat_inv_prod.edit\":true,\"cat_inv_prod.delete\":true,\"cat_inv_prod.price_change\":true,\"cat_inv_prod.view_sell_price\":true,\"cat_inv_prod.view_cost_price\":true,\"cat_inv_prod.restricted\":true,\"cat_inv_sv_task.menu\":true,\"cat_inv_sv_task.view\":true,\"cat_inv_trans.menu\":true,\"gist_supplier.menu\":true,\"gist_supp.menu\":true,\"gist_supp.view\":true,\"gist_supp.add\":true,\"gist_supp.edit\":true,\"gist_supp.delete\":true,\"gist_inv_pos.menu\":true,\"gist_inv_pos.view\":true,\"gist_inv_pos.add\":true,\"gist_inv_pos.edit\":true,\"gist_inv_pos.delete\":true}}'),(311,1,'2017-07-09 19:29:42','cat_user_user_add','added User 19.','','{\"id\":19,\"username\":\"000019\",\"email\":\"\",\"enabled\":true,\"groups\":[]}'),(312,1,'2017-07-09 19:30:55','cat_user_user_add','added User 20.','','{\"id\":20,\"username\":\"000020\",\"email\":\"jke@generic.com\",\"enabled\":true,\"groups\":[]}'),(313,1,'2017-07-09 19:36:04','cat_user_user_update','updated User 19.','','{\"id\":19,\"username\":\"000019\",\"email\":\"lmh@generic.com\",\"enabled\":true,\"groups\":[]}'),(314,1,'2017-07-09 19:36:28','cat_user_user_delete','deleted User 18.','','{\"id\":18,\"username\":\"adminxxx\",\"email\":\"abc@edf.com\",\"enabled\":true,\"groups\":[]}'),(315,1,'2017-07-09 19:43:48','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(316,1,'2017-07-09 20:05:19','cat_inv_product_type_add','added Product Type 1.','','{\"id\":1,\"name\":\"Goods\"}'),(317,1,'2017-07-09 20:05:48','cat_inv_product_type_add','added Product Type 2.','','{\"id\":2,\"name\":\"Consumables\"}'),(318,1,'2017-07-09 20:06:02','cat_inv_product_type_add','added Product Type 3.','','{\"id\":3,\"name\":\"Fixed\"}'),(319,1,'2017-07-09 20:06:19','cat_inv_product_type_add','added Product Type 4.','','{\"id\":4,\"name\":\"Package\"}'),(320,1,'2017-07-09 20:08:09','cat_inv_prod_update','updated Product 6.','','{\"id\":6,\"name\":\"24K Intensive Face Cream\"}'),(321,1,'2017-07-09 20:08:33','cat_inv_prod_update','updated Product 7.','','{\"id\":7,\"name\":\"24K Intensive Face Serum\"}'),(322,1,'2017-07-09 20:08:55','cat_inv_prod_update','updated Product 8.','','{\"id\":8,\"name\":\"24K Intensive Mask\"}'),(323,1,'2017-07-09 20:09:57','cat_inv_prod_update','updated Product 9.','','{\"id\":9,\"name\":\"Blissful Body Butter - Springtime\"}'),(324,1,'2017-07-09 20:14:00','cat_user_group_add','added Position 26.','','{\"id\":26,\"access\":[]}'),(325,1,'2017-07-09 20:14:52','cat_user_group_update','updated Position 26.','','{\"id\":26,\"access\":{\"cat_dashboard.menu\":true,\"hris_dashboard.view\":true,\"hris_dashboard.edit\":true,\"hris_dashboard_admin.view\":true,\"hris_dashboard_request.view\":true}}'),(326,1,'2017-07-09 20:17:14','cat_user_department_add','added Department 9.','','{\"id\":9,\"date_create\":\"2017-07-09 20:17:14\",\"user_create\":null}'),(327,1,'2017-07-09 20:17:42','cat_user_department_add','added Department 10.','','{\"id\":10,\"date_create\":\"2017-07-09 20:17:42\",\"user_create\":null}'),(328,1,'2017-07-09 20:18:18','cat_user_items_list_add','added Item 16.','','{\"id\":16,\"date_create\":\"2017-07-09 20:18:18\",\"user_create\":null}'),(329,1,'2017-07-09 20:18:44','cat_user_user_update','updated User 19.','','{\"id\":19,\"username\":\"000019\",\"email\":\"lmh@generic.com\",\"enabled\":true,\"groups\":[]}'),(330,1,'2017-07-09 20:20:15','cat_user_user_update','updated User 19.','','{\"id\":19,\"username\":\"000019\",\"email\":\"lmh@generic.com\",\"enabled\":true,\"groups\":[]}'),(331,1,'2017-07-09 20:20:44','cat_user_user_update','updated User 19.','','{\"id\":19,\"username\":\"000019\",\"email\":\"lmh@generic.com\",\"enabled\":true,\"groups\":[]}'),(332,1,'2017-07-09 20:21:14','gist_loc_areas_update','updated Area 1.','','{\"id\":1,\"date_create\":\"2017-06-07 12:31:48\",\"user_create\":null}'),(333,1,'2017-07-09 20:21:39','gist_loc_areas_update','updated Area 2.','','{\"id\":2,\"date_create\":\"2017-07-03 22:06:03\",\"user_create\":null}'),(334,1,'2017-07-09 20:22:00','gist_loc_areas_update','updated Area 3.','','{\"id\":3,\"date_create\":\"2017-07-05 22:44:42\",\"user_create\":null}'),(335,1,'2017-07-09 20:22:20','gist_loc_areas_add','added Area 4.','','{\"id\":4,\"date_create\":\"2017-07-09 20:22:20\",\"user_create\":null}'),(336,1,'2017-07-09 20:31:03','gist_loc_pos_locations_add','added POS Location 5.','','{\"id\":5,\"date_create\":\"2017-07-09 20:31:03\",\"user_create\":null}'),(337,1,'2017-07-09 20:31:26','gist_loc_areas_add','added Area 5.','','{\"id\":5,\"date_create\":\"2017-07-09 20:31:26\",\"user_create\":null}'),(338,1,'2017-07-09 20:31:42','gist_loc_pos_locations_update','updated POS Location 5.','','{\"id\":5,\"date_create\":\"2017-07-09 20:31:03\",\"user_create\":null}'),(339,1,'2017-07-09 20:32:12','gist_accounting_banks_add','added Bank 2.','','{\"id\":2,\"date_create\":\"2017-07-09 20:32:12\",\"user_create\":null}'),(340,1,'2017-07-09 20:32:27','gist_accounting_banks_add','added Bank 3.','','{\"id\":3,\"date_create\":\"2017-07-09 20:32:27\",\"user_create\":null}'),(341,1,'2017-07-09 20:33:14','gist_accounting_bank_accounts_add','added Bank Account 3.','','{\"id\":3,\"date_create\":\"2017-07-09 20:33:14\",\"user_create\":null}'),(342,1,'2017-07-09 20:34:27','gist_terminals_terminal_add','added Terminal 3.','','{\"id\":3,\"date_create\":\"2017-07-09 20:34:27\",\"user_create\":null}'),(343,1,'2017-07-09 20:35:23','gist_terminals_terminal_operator_add','added Terminal Operator 2.','','{\"id\":2,\"date_create\":\"2017-07-09 20:35:23\",\"user_create\":null}'),(344,1,'2017-07-09 20:37:40','cat_inv_prod_add','added Product 10.','','{\"id\":10,\"name\":\"Body Lotion - Delicate Dew (Big)\"}'),(345,1,'2017-07-09 20:38:36','cat_inv_brand_add','added Brand 5.','','{\"id\":5,\"name\":\"Generic\"}'),(346,1,'2017-07-09 20:39:23','cat_inv_product_category_add','added Product Category 9.','','{\"id\":9,\"name\":\"Optima+\"}'),(347,1,'2017-07-09 20:39:36','cat_inv_product_category_add','added Product Category 10.','','{\"id\":10,\"name\":\"Nail Care\"}'),(348,1,'2017-07-09 20:40:41','gist_supp_add','added Supplier 4.','','{\"id\":4,\"name\":\"Haia\"}');
...
INSERT INTO `media_storage_localfile` VALUES (1,1,'/var/www/html/gist_erp2/app/../web/uploads/34/fc/34/fc/591844c47fc34.pdf'),(2,2,'/var/www/html/gist_erp2/app/../web/uploads/d4/7a/d4/7a/5918453157ad4.pdf'),(3,3,'/var/www/html/gist_erp2/app/../web/uploads/4f/20/4f/20/591847fc2204f.pdf'),(4,4,'/var/www/html/gist_erp2/app/../web/uploads/d3/40/d3/40/591b1abf640d3.pdf'),(5,5,'/var/www/html/gist_erp2/app/../web/uploads/b4/32/b4/32/591b1ac1332b4.pdf'),(6,6,'/var/www/html/gist_erp2/app/../web/uploads/96/b6/96/b6/591b1b548b696.pdf'),(7,7,'/var/www/html/gist_erp2/app/../web/uploads/71/4a/71/4a/591b1b58b4a71.pdf'),(8,8,'/var/www/html/gist_erp2/app/../web/uploads/0e/ef/0e/ef/591b1c410ef0e.pdf'),(9,9,'/var/www/html/gist_erp2/app/../web/uploads/f4/39/f4/39/591b1c4b039f4.pdf'),(10,10,'/var/www/html/gist_erp2/app/../web/uploads/7b/32/7b/32/591b1d2d2327b.pdf'),(11,11,'/var/www/html/gist_erp2/app/../web/uploads/6c/e7/6c/e7/5920d9c2ce76c.pdf'),(12,12,'/var/www/html/gist_erp2/app/../web/uploads/f6/ca/f6/ca/5920db9bbcaf6.pdf'),(13,13,'/var/www/html/gist_erp2/app/../web/uploads/25/4e/25/4e/5920dba504e25.pdf'),(14,14,'/var/www/html/gist_erp2/app/../web/uploads/8c/eb/8c/eb/592a0976eeb8c.PNG'),(15,15,'/var/www/html/gist_erp2/app/../web/uploads/34/85/34/85/592a099888534.PNG'),(16,16,'/var/www/html/gist_erp2/app/../web/uploads/49/58/49/58/5945e63115849.pdf'),(17,17,'/var/www/html/gist_erp2/app/../web/uploads/01/c0/01/c0/5945e6cddc001.pdf'),(18,18,'/var/www/html/gist_erp2/app/../web/uploads/cb/de/cb/de/5945e6d4cdecb.pdf'),(19,19,'/var/www/html/gist_erp2/app/../web/uploads/ad/4f/ad/4f/5945e71bb4fad.pdf'),(20,20,'/var/www/html/gist_erp2/app/../web/uploads/f4/66/f4/66/5945e75f366f4.xls'),(21,21,'/var/www/html/gist_erp2/app/../web/uploads/01/a5/01/a5/5946029b9a501.pdf'),(22,22,'/var/www/html/gist_erp2/app/../web/uploads/0a/24/0a/24/5946049c1240a.pdf'),(23,23,'/var/www/html/gist_erp2/app/../web/uploads/c5/9e/c5/9e/5946136e19ec5.pdf'),(24,24,'/var/www/html/gist_erp2/app/../web/uploads/1f/ff/1f/ff/59462aa0aff1f.pdf'),(25,25,'/var/www/html/gist_erp2/app/../web/uploads/1c/0d/1c/0d/59462ffc40d1c.pdf'),(26,26,'/var/www/html/gist_erp2/app/../web/uploads/9e/b2/9e/b2/594631c04b29e.pdf'),(27,27,'/var/www/html/gist_erp2/app/../web/uploads/77/49/77/49/5946321774977.PNG'),(28,28,'/var/www/html/gist_erp2/app/../web/uploads/08/b3/08/b3/59464dd69b308.pdf'),(29,29,'/var/www/html/gist_erp2/app/../web/uploads/3e/0b/3e/0b/59464e1880b3e.PNG'),(30,30,'/var/www/html/gist_erp2/app/../web/uploads/29/bb/29/bb/59464e285bb29.pdf'),(31,31,'/var/www/html/gist_erp2/app/../web/uploads/1b/57/1b/57/59464fbb4571b.jpg'),(32,32,'/var/www/html/gist_erp2/app/../web/uploads/88/dd/88/dd/5946525d6dd88.jpg'),(33,33,'/var/www/html/gist_erp2/app/../web/uploads/6e/0f/6e/0f/5946526710f6e.PNG'),(34,34,'/var/www/html/gist_erp2/app/../web/uploads/62/6d/62/6d/594652e466d62.png'),(35,35,'/var/www/html/gist_erp2/app/../web/uploads/a4/51/a4/51/59465463d51a4.jpg'),(36,36,'/var/www/html/gist_erp2/app/../web/uploads/cb/c6/cb/c6/5946546fbc6cb.PNG'),(37,37,'/var/www/html/gist_erp2/app/../web/uploads/a6/50/a6/50/5946550b250a6.PNG'),(38,38,'/var/www/html/gist_erp2/app/../web/uploads/75/8a/75/8a/59465538a8a75.PNG'),(39,39,'/var/www/html/gist_erp2/app/../web/uploads/9c/f7/9c/f7/5946772abf79c.jpg'),(40,40,'/var/www/html/gist_erp2/app/../web/uploads/33/38/33/38/5958335493833.docx'),(41,41,'/var/www/html/gist_erp2/app/../web/uploads/0d/4a/0d/4a/5958337bd4a0d.doc'),(42,42,'/var/www/html/gist_erp2/app/../web/uploads/d2/bf/d2/bf/59586281abfd2.jpg'),(43,43,'/var/www/html/gist_erp2/app/../web/uploads/cd/e1/cd/e1/5958631e3e1cd.jpg'),(44,44,'/var/www/html/gist_erp2/app/../web/uploads/b2/74/b2/74/59586394474b2.jpg'),(45,45,'/var/www/html/gist_erp2/app/../web/uploads/25/19/25/19/595a4eb1c1925.pdf'),(46,46,'/var/www/html/gist_erp2/app/../web/uploads/82/41/82/41/595cf25894182.png'),(47,47,'/var/www/html/gist_erp2/app/../web/uploads/b3/69/b3/69/5962234f369b3.jpg');
...
INSERT INTO `media_upload` VALUES (1,1,',  - Employment Contract','http://dev.gisterp2/uploads/34/fc/591844c47fc34.pdf',1,'local_file','2017-05-14 19:51:32'),(2,1,'5918453157ad4.pdf','http://dev.gisterp2/uploads/d4/7a/5918453157ad4.pdf',1,'local_file','2017-05-14 19:53:21'),(3,1,'591847fc2204f.pdf','http://dev.gisterp2/uploads/4f/20/591847fc2204f.pdf',1,'local_file','2017-05-14 20:05:16'),(4,1,'591b1abf640d3.pdf','http://dev.gisterp2/uploads/d3/40/591b1abf640d3.pdf',1,'local_file','2017-05-16 23:29:03'),(5,1,'591b1ac1332b4.pdf','http://dev.gisterp2/uploads/b4/32/591b1ac1332b4.pdf',1,'local_file','2017-05-16 23:29:05'),(6,1,'591b1b548b696.pdf','http://dev.gisterp2/uploads/96/b6/591b1b548b696.pdf',1,'local_file','2017-05-16 23:31:32'),(7,1,'591b1b58b4a71.pdf','http://dev.gisterp2/uploads/71/4a/591b1b58b4a71.pdf',1,'local_file','2017-05-16 23:31:36'),(8,1,'591b1c410ef0e.pdf','http://dev.gisterp2/uploads/0e/ef/591b1c410ef0e.pdf',1,'local_file','2017-05-16 23:35:29'),(9,1,'591b1c4b039f4.pdf','http://dev.gisterp2/uploads/f4/39/591b1c4b039f4.pdf',1,'local_file','2017-05-16 23:35:39'),(10,1,'591b1d2d2327b.pdf','http://dev.gisterp2/uploads/7b/32/591b1d2d2327b.pdf',1,'local_file','2017-05-16 23:39:25'),(11,1,'5920d9c2ce76c.pdf','http://dev.gisterp2/uploads/6c/e7/5920d9c2ce76c.pdf',1,'local_file','2017-05-21 08:05:22'),(12,1,'5920db9bbcaf6.pdf','http://dev.gisterp2/uploads/f6/ca/5920db9bbcaf6.pdf',1,'local_file','2017-05-21 08:13:15'),(13,1,'5920dba504e25.pdf','http://dev.gisterp2/uploads/25/4e/5920dba504e25.pdf',1,'local_file','2017-05-21 08:13:25'),(14,1,'592a0976eeb8c.PNG','http://dev.gisterp2/uploads/8c/eb/592a0976eeb8c.PNG',1,'local_file','2017-05-28 07:19:18'),(15,1,'592a099888534.PNG','http://dev.gisterp2/uploads/34/85/592a099888534.PNG',1,'local_file','2017-05-28 07:19:52'),(16,1,'5945e63115849.pdf','http://dev.gisterp2/uploads/49/58/5945e63115849.pdf',1,'local_file','2017-06-18 10:32:17'),(17,1,'5945e6cddc001.pdf','http://dev.gisterp2/uploads/01/c0/5945e6cddc001.pdf',1,'local_file','2017-06-18 10:34:53'),(18,1,'5945e6d4cdecb.pdf','http://dev.gisterp2/uploads/cb/de/5945e6d4cdecb.pdf',1,'local_file','2017-06-18 10:35:00'),(19,1,'5945e71bb4fad.pdf','http://dev.gisterp2/uploads/ad/4f/5945e71bb4fad.pdf',1,'local_file','2017-06-18 10:36:11'),(20,1,'5945e75f366f4.xls','http://dev.gisterp2/uploads/f4/66/5945e75f366f4.xls',1,'local_file','2017-06-18 10:37:19'),(21,1,'5946029b9a501.pdf','http://dev.gisterp2/uploads/01/a5/5946029b9a501.pdf',1,'local_file','2017-06-18 12:33:31'),(22,1,'5946049c1240a.pdf','http://dev.gisterp2/uploads/0a/24/5946049c1240a.pdf',1,'local_file','2017-06-18 12:42:04'),(23,1,'5946136e19ec5.pdf','http://dev.gisterp2/uploads/c5/9e/5946136e19ec5.pdf',1,'local_file','2017-06-18 13:45:18'),(24,1,'59462aa0aff1f.pdf','http://dev.gisterp2/uploads/1f/ff/59462aa0aff1f.pdf',1,'local_file','2017-06-18 15:24:16'),(25,1,'59462ffc40d1c.pdf','http://dev.gisterp2/uploads/1c/0d/59462ffc40d1c.pdf',1,'local_file','2017-06-18 15:47:08'),(26,1,'594631c04b29e.pdf','http://dev.gisterp2/uploads/9e/b2/594631c04b29e.pdf',1,'local_file','2017-06-18 15:54:40'),(27,1,'5946321774977.PNG','http://dev.gisterp2/uploads/77/49/5946321774977.PNG',1,'local_file','2017-06-18 15:56:07'),(28,1,'59464dd69b308.pdf','http://dev.gisterp2/uploads/08/b3/59464dd69b308.pdf',1,'local_file','2017-06-18 17:54:30'),(29,1,'59464e1880b3e.PNG','http://dev.gisterp2/uploads/3e/0b/59464e1880b3e.PNG',1,'local_file','2017-06-18 17:55:36'),(30,1,'59464e285bb29.pdf','http://dev.gisterp2/uploads/29/bb/59464e285bb29.pdf',1,'local_file','2017-06-18 17:55:52'),(31,1,'59464fbb4571b.jpg','http://dev.gisterp2/uploads/1b/57/59464fbb4571b.jpg',1,'local_file','2017-06-18 18:02:35'),(32,1,'5946525d6dd88.jpg','http://dev.gisterp2/uploads/88/dd/5946525d6dd88.jpg',1,'local_file','2017-06-18 18:13:49'),(33,1,'5946526710f6e.PNG','http://dev.gisterp2/uploads/6e/0f/5946526710f6e.PNG',1,'local_file','2017-06-18 18:13:59'),(34,1,'594652e466d62.png','http://dev.gisterp2/uploads/62/6d/594652e466d62.png',1,'local_file','2017-06-18 18:16:04'),(35,1,'59465463d51a4.jpg','http://dev.gisterp2/uploads/a4/51/59465463d51a4.jpg',1,'local_file','2017-06-18 18:22:27'),(36,1,'5946546fbc6cb.PNG','http://dev.gisterp2/uploads/cb/c6/5946546fbc6cb.PNG',1,'local_file','2017-06-18 18:22:39'),(37,1,'5946550b250a6.PNG','http://dev.gisterp2/uploads/a6/50/5946550b250a6.PNG',1,'local_file','2017-06-18 18:25:15'),(38,1,'59465538a8a75.PNG','http://dev.gisterp2/uploads/75/8a/59465538a8a75.PNG',1,'local_file','2017-06-18 18:26:00'),(39,1,'5946772abf79c.jpg','http://dev.gisterp2/uploads/9c/f7/5946772abf79c.jpg',1,'local_file','2017-06-18 20:50:50'),(40,1,'5958335493833.docx','http://dev.gisterp2/uploads/33/38/5958335493833.docx',1,'local_file','2017-07-02 07:42:12'),(41,1,'5958337bd4a0d.doc','http://dev.gisterp2/uploads/0d/4a/5958337bd4a0d.doc',1,'local_file','2017-07-02 07:42:51'),(42,1,'59586281abfd2.jpg','http://dev.gisterp2/uploads/d2/bf/59586281abfd2.jpg',1,'local_file','2017-07-02 11:03:29'),(43,1,'5958631e3e1cd.jpg','http://dev.gisterp2/uploads/cd/e1/5958631e3e1cd.jpg',1,'local_file','2017-07-02 11:06:06'),(44,1,'59586394474b2.jpg','http://dev.gisterp2/uploads/b2/74/59586394474b2.jpg',1,'local_file','2017-07-02 11:08:04'),(45,1,'595a4eb1c1925.pdf','http://dev.gisterp2/uploads/25/19/595a4eb1c1925.pdf',1,'local_file','2017-07-03 22:03:29'),(46,1,'595cf25894182.png','http://dev.gisterp2/uploads/82/41/595cf25894182.png',1,'local_file','2017-07-05 22:06:16'),(47,1,'5962234f369b3.jpg','http://dev.gisterp2/uploads/b3/69/5962234f369b3.jpg',1,'local_file','2017-07-09 20:36:31');
...
INSERT INTO `pay_schedule` VALUES (1,1,1,'{\"weekly_start\":0,\"weekly_end\":5,\"weekly_pay\":1,\"monthly_start\":28,\"monthly_end\":27,\"monthly_pay\":0,\"semimonthly_start1\":26,\"semimonthly_end1\":10,\"semimonthly_pay1\":15,\"semimonthly_start2\":11,\"semimonthly_end2\":25,\"semimonthly_pay2\":0}','Semi-Monthly','2017-05-08 22:18:48'),(2,3,1,'{\"weekly_start\":0,\"weekly_end\":5,\"weekly_pay\":1,\"monthly_start\":28,\"monthly_end\":27,\"monthly_pay\":0,\"semimonthly_start1\":26,\"semimonthly_end1\":10,\"semimonthly_pay1\":15,\"semimonthly_start2\":11,\"semimonthly_end2\":25,\"semimonthly_pay2\":0}','Weekly','2017-05-08 22:18:48');
...
CREATE TABLE `user_area` (
  ...
  `date_create` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_AD1571A1EEFE5067` (`user_create_id`),
  CONSTRAINT `FK_AD1571A1EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_areas` (
  ...
  `date_create` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_BA724904EEFE5067` (`user_create_id`),
  CONSTRAINT `FK_BA724904EEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_areas` VALUES (3,NULL,'Team Generic','2017-06-01 06:56:51');
...
INSERT INTO `user_department` VALUES (2,NULL,'IT','2017-05-13 07:07:54',NULL),(3,NULL,'Human Resources','2017-05-13 07:10:15',NULL),(4,NULL,'Administrative','2017-05-14 19:48:42',NULL),(5,NULL,'Sales','2017-06-01 08:32:31',NULL),(6,NULL,'Marketing','2017-06-01 08:32:42',NULL),(7,NULL,'Call Center','2017-06-01 08:32:53',NULL),(8,NULL,'Finance','2017-06-01 08:33:04',NULL),(9,NULL,'Public Relation and Marketing','2017-07-09 20:17:14',NULL),(10,NULL,'Logistics and Maintenance','2017-07-09 20:17:42',NULL);
...
INSERT INTO `user_group` VALUES (15,'System Administrator','a:0:{}','a:111:{s:18:\"cat_dashboard.menu\";b:1;s:19:\"hris_dashboard.view\";b:1;s:19:\"hris_dashboard.edit\";b:1;s:25:\"hris_dashboard_admin.view\";b:1;s:27:\"hris_dashboard_request.view\";b:1;s:15:\"cat_config.menu\";b:1;s:15:\"cat_config.view\";b:1;s:15:\"cat_config.edit\";b:1;s:20:\"gist_accounting.menu\";b:1;s:34:\"gist_accounting_bank_accounts.menu\";b:1;s:34:\"gist_accounting_bank_accounts.view\";b:1;s:33:\"gist_accounting_bank_accounts.add\";b:1;s:34:\"gist_accounting_bank_accounts.edit\";b:1;s:36:\"gist_accounting_bank_accounts.delete\";b:1;s:26:\"gist_accounting_banks.menu\";b:1;s:26:\"gist_accounting_banks.view\";b:1;s:25:\"gist_accounting_banks.add\";b:1;s:26:\"gist_accounting_banks.edit\";b:1;s:28:\"gist_accounting_banks.delete\";b:1;s:19:\"gist_terminals.menu\";b:1;s:28:\"gist_terminals_terminal.menu\";b:1;s:28:\"gist_terminals_terminal.view\";b:1;s:27:\"gist_terminals_terminal.add\";b:1;s:28:\"gist_terminals_terminal.edit\";b:1;s:30:\"gist_terminals_terminal.delete\";b:1;s:37:\"gist_terminals_terminal_operator.menu\";b:1;s:37:\"gist_terminals_terminal_operator.view\";b:1;s:36:\"gist_terminals_terminal_operator.add\";b:1;s:37:\"gist_terminals_terminal_operator.edit\";b:1;s:39:\"gist_terminals_terminal_operator.delete\";b:1;s:13:\"gist_loc.menu\";b:1;s:19:\"gist_loc_areas.menu\";b:1;s:19:\"gist_loc_areas.view\";b:1;s:18:\"gist_loc_areas.add\";b:1;s:19:\"gist_loc_areas.edit\";b:1;s:21:\"gist_loc_areas.delete\";b:1;s:27:\"gist_loc_pos_locations.menu\";b:1;s:27:\"gist_loc_pos_locations.view\";b:1;s:26:\"gist_loc_pos_locations.add\";b:1;s:27:\"gist_loc_pos_locations.edit\";b:1;s:29:\"gist_loc_pos_locations.delete\";b:1;s:13:\"cat_hris.menu\";b:1;s:18:\"cat_user_user.menu\";b:1;s:18:\"cat_user_user.view\";b:1;s:17:\"cat_user_user.add\";b:1;s:18:\"cat_user_user.edit\";b:1;s:20:\"cat_user_user.delete\";b:1;s:19:\"cat_user_group.menu\";b:1;s:19:\"cat_user_group.view\";b:1;s:18:\"cat_user_group.add\";b:1;s:19:\"cat_user_group.edit\";b:1;s:21:\"cat_user_group.delete\";b:1;s:24:\"cat_user_department.menu\";b:1;s:24:\"cat_user_department.view\";b:1;s:23:\"cat_user_department.add\";b:1;s:24:\"cat_user_department.edit\";b:1;s:26:\"cat_user_department.delete\";b:1;s:24:\"cat_user_items_list.menu\";b:1;s:24:\"cat_user_items_list.view\";b:1;s:23:\"cat_user_items_list.add\";b:1;s:24:\"cat_user_items_list.edit\";b:1;s:26:\"cat_user_items_list.delete\";b:1;s:12:\"cat_inv.menu\";b:1;s:15:\"cat_inv_wh.menu\";b:1;s:15:\"cat_inv_wh.view\";b:1;s:14:\"cat_inv_wh.add\";b:1;s:15:\"cat_inv_wh.edit\";b:1;s:17:\"cat_inv_wh.delete\";b:1;s:18:\"cat_inv_brand.menu\";b:1;s:18:\"cat_inv_brand.view\";b:1;s:17:\"cat_inv_brand.add\";b:1;s:18:\"cat_inv_brand.edit\";b:1;s:20:\"cat_inv_brand.delete\";b:1;s:29:\"cat_inv_product_category.menu\";b:1;s:29:\"cat_inv_product_category.view\";b:1;s:28:\"cat_inv_product_category.add\";b:1;s:29:\"cat_inv_product_category.edit\";b:1;s:31:\"cat_inv_product_category.delete\";b:1;s:25:\"cat_inv_product_type.menu\";b:1;s:25:\"cat_inv_product_type.view\";b:1;s:24:\"cat_inv_product_type.add\";b:1;s:25:\"cat_inv_product_type.edit\";b:1;s:27:\"cat_inv_product_type.delete\";b:1;s:15:\"cat_inv_pg.menu\";b:1;s:15:\"cat_inv_pg.view\";b:1;s:14:\"cat_inv_pg.add\";b:1;s:15:\"cat_inv_pg.edit\";b:1;s:17:\"cat_inv_pg.delete\";b:1;s:17:\"cat_inv_prod.menu\";b:1;s:17:\"cat_inv_prod.view\";b:1;s:16:\"cat_inv_prod.add\";b:1;s:17:\"cat_inv_prod.edit\";b:1;s:19:\"cat_inv_prod.delete\";b:1;s:25:\"cat_inv_prod.price_change\";b:1;s:28:\"cat_inv_prod.view_sell_price\";b:1;s:28:\"cat_inv_prod.view_cost_price\";b:1;s:23:\"cat_inv_prod.restricted\";b:1;s:20:\"cat_inv_sv_task.menu\";b:1;s:20:\"cat_inv_sv_task.view\";b:1;s:18:\"cat_inv_trans.menu\";b:1;s:18:\"gist_supplier.menu\";b:1;s:14:\"gist_supp.menu\";b:1;s:14:\"gist_supp.view\";b:1;s:13:\"gist_supp.add\";b:1;s:14:\"gist_supp.edit\";b:1;s:16:\"gist_supp.delete\";b:1;s:17:\"gist_inv_pos.menu\";b:1;s:17:\"gist_inv_pos.view\";b:1;s:16:\"gist_inv_pos.add\";b:1;s:17:\"gist_inv_pos.edit\";b:1;s:19:\"gist_inv_pos.delete\";b:1;}',4,25,''),(18,'HR Administrator','a:0:{}','a:62:{s:18:\"cat_dashboard.menu\";b:1;s:19:\"hris_dashboard.view\";b:1;s:19:\"hris_dashboard.edit\";b:1;s:25:\"hris_dashboard_admin.view\";b:1;s:27:\"hris_dashboard_request.view\";b:1;s:15:\"cat_config.menu\";b:1;s:15:\"cat_config.view\";b:1;s:15:\"cat_config.edit\";b:1;s:13:\"cat_hris.menu\";b:1;s:18:\"cat_user_user.menu\";b:1;s:18:\"cat_user_user.view\";b:1;s:17:\"cat_user_user.add\";b:1;s:18:\"cat_user_user.edit\";b:1;s:20:\"cat_user_user.delete\";b:1;s:19:\"cat_user_group.menu\";b:1;s:19:\"cat_user_group.view\";b:1;s:18:\"cat_user_group.add\";b:1;s:19:\"cat_user_group.edit\";b:1;s:21:\"cat_user_group.delete\";b:1;s:24:\"cat_user_department.menu\";b:1;s:24:\"cat_user_department.view\";b:1;s:23:\"cat_user_department.add\";b:1;s:24:\"cat_user_department.edit\";b:1;s:26:\"cat_user_department.delete\";b:1;s:24:\"cat_user_items_list.menu\";b:1;s:24:\"cat_user_items_list.view\";b:1;s:23:\"cat_user_items_list.add\";b:1;s:24:\"cat_user_items_list.edit\";b:1;s:26:\"cat_user_items_list.delete\";b:1;s:12:\"cat_inv.menu\";b:1;s:15:\"cat_inv_wh.menu\";b:1;s:15:\"cat_inv_wh.view\";b:1;s:14:\"cat_inv_wh.add\";b:1;s:15:\"cat_inv_wh.edit\";b:1;s:17:\"cat_inv_wh.delete\";b:1;s:18:\"cat_inv_brand.menu\";b:1;s:18:\"cat_inv_brand.view\";b:1;s:17:\"cat_inv_brand.add\";b:1;s:18:\"cat_inv_brand.edit\";b:1;s:20:\"cat_inv_brand.delete\";b:1;s:29:\"cat_inv_product_category.menu\";b:1;s:29:\"cat_inv_product_category.view\";b:1;s:28:\"cat_inv_product_category.add\";b:1;s:29:\"cat_inv_product_category.edit\";b:1;s:31:\"cat_inv_product_category.delete\";b:1;s:15:\"cat_inv_pg.menu\";b:1;s:15:\"cat_inv_pg.view\";b:1;s:14:\"cat_inv_pg.add\";b:1;s:15:\"cat_inv_pg.edit\";b:1;s:17:\"cat_inv_pg.delete\";b:1;s:17:\"cat_inv_prod.menu\";b:1;s:17:\"cat_inv_prod.view\";b:1;s:16:\"cat_inv_prod.add\";b:1;s:17:\"cat_inv_prod.edit\";b:1;s:19:\"cat_inv_prod.delete\";b:1;s:25:\"cat_inv_prod.price_change\";b:1;s:28:\"cat_inv_prod.view_sell_price\";b:1;s:28:\"cat_inv_prod.view_cost_price\";b:1;s:23:\"cat_inv_prod.restricted\";b:1;s:20:\"cat_inv_sv_task.menu\";b:1;s:20:\"cat_inv_sv_task.view\";b:1;s:18:\"cat_inv_trans.menu\";b:1;}',3,15,NULL),(19,'Junior Beauty Consultant','a:0:{}','a:0:{}',5,18,''),(20,'Senior Beauty Consultant','a:0:{}','a:0:{}',5,18,''),(21,'Area Manager','a:0:{}','a:5:{s:18:\"cat_dashboard.menu\";b:1;s:19:\"hris_dashboard.view\";b:1;s:19:\"hris_dashboard.edit\";b:1;s:25:\"hris_dashboard_admin.view\";b:1;s:27:\"hris_dashboard_request.view\";b:1;}',4,18,''),(22,'Assistant Manager','a:0:{}','a:0:{}',4,21,''),(23,'Test 07/03/2017','a:0:{}','a:0:{}',7,18,'asdf'),(24,'Test Child 07/03/2017','a:0:{}','a:0:{}',2,23,'asdasd'),(25,'CEO','a:0:{}','a:0:{}',4,NULL,''),(26,'Kiosk Supervisor','a:0:{}','a:5:{s:18:\"cat_dashboard.menu\";b:1;s:19:\"hris_dashboard.view\";b:1;s:19:\"hris_dashboard.edit\";b:1;s:25:\"hris_dashboard_admin.view\";b:1;s:27:\"hris_dashboard_request.view\";b:1;}',5,NULL,'');
...
INSERT INTO `user_items_list` VALUES (4,NULL,'Dell Inspiron 5559','G124FRE374','2017-05-21 08:06:29'),(5,NULL,'Asus Zenfone 4','19JKH8934JD9','2017-05-21 08:06:57'),(6,NULL,'Dell Laptop Bag','','2017-05-21 08:07:10'),(7,NULL,'Uniform (Small)','','2017-05-21 08:07:33'),(8,NULL,'Uniform (Medium)','','2017-05-21 08:07:43'),(9,NULL,'Uniform (Large)','','2017-05-21 08:07:54'),(10,NULL,'Apple iPhone 7 (Red)','901829343','2017-05-21 08:08:13'),(11,NULL,'Apple iPhone 6s (White)','301342343','2017-05-21 08:08:42'),(12,NULL,'Smart Prepaid Sim Card','63998954323','2017-05-21 08:09:14'),(13,NULL,'Dell XPS 15','329485HFG09','2017-05-21 08:09:46'),(14,NULL,'Bag','','2017-07-04 04:47:24'),(15,NULL,'Mitsubishi Lancer ','34AB596-3425-3DE354','2017-07-04 04:48:13'),(16,NULL,'Buffer','000023','2017-07-09 20:18:18');
/*!40000 ALTER TABLE `user_items_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_pos_locations`
--

DROP TABLE IF EXISTS `user_pos_locations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_pos_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_create_id` int(11) DEFAULT NULL,
  ...
  `status` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_DFF8D30CEEFE5067` (`user_create_id`),
  KEY `IDX_DFF8D30CBD0F409C` (`area_id`),
  CONSTRAINT `FK_DFF8D30CBD0F409C` FOREIGN KEY (`area_id`) REFERENCES `user_areas` (`id`),
  CONSTRAINT `FK_DFF8D30CEEFE5067` FOREIGN KEY (`user_create_id`) REFERENCES `user_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_pos_locations`
--

LOCK TABLES `user_pos_locations` WRITE;
/*!40000 ALTER TABLE `user_pos_locations` DISABLE KEYS */;
INSERT INTO `user_pos_locations` VALUES (1,NULL,'(Davao) Abreeza Mall','2017-06-01 07:04:43',3,'AQUA','09178669123','','Abreeza Ayala Business Park, J.P. Laurel Ave, Pobl','Kiosk','Botanifique','Davao','','','','Active'),(2,NULL,'Ayala Fairview Terraces','2017-06-01 08:30:33',3,'North Ventures Commercial Corp','09178476894','','2nd Floor near Skechers','Kiosk','Aqua Mineral','Quezon City','','','','Active');
/*!40000 ALTER TABLE `user_pos_locations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_position` (
  ...
  `access` longtext COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_A6A100F55E237E06` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_user` (
  ...
  `life_insurance_expiration` date NOT NULL,
...
INSERT INTO `user_user` VALUES (1,NULL,'admin','admin',1,'fhqsoge52l4c8kw0cow0gsc8kscww80','I+1fZU2kCil0Jr0X7eWaEuY3WWtNlrsVXR3MvJSjbh6KKcePiUD1+iiVJptrzKvPqcJ7oZOQr9TlLeJ9egroxQ==','2017-07-09 19:13:56',NULL,NULL,'a:0:{}','Richard',1,'sys_ad@test.com','sys_ad@test.com',15,15,'Richard','G','Gaza','0','Approver 1','Variable','','','2017-06-01','','','','2019-06-04','','','','','.','.','.','.','2015-11-18','0111-11-10','0','aaa',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(12,NULL,'hr_admin','hr_admin',1,'91fv4dyh6gcokowgk0g48wg8woo8gww','OTpISAHGoiVLvdH9Qar0dLdWSCnQGqjkTyOkvmtiz4IrT3zFWPT4SP8GeKlCZ2iN1cm9+l8ojxziJt241Mle1g==',NULL,NULL,NULL,'a:0:{}','Victoria',1,'vgelmo@test.com','vgelmo@test.com',18,NULL,'Victoria','Abril','Gelmo','0','no','Straight','0','Filipino','2017-06-11','San Pedro, Laguna','Taguig City, Metro Manila','Asian Life','2018-11-15','1908423-14','0923134','294842389','342-234-187-000','Lorna Gelmo','0','Mother','n/a','2017-04-13','2019-11-14','0','',NULL,NULL,NULL,NULL,NULL,NULL,'4566'),(13,NULL,'ad13','ad13',1,'8iz3cx9wthc0k8cogo8cowccsso00cc','V5Lgij75acC5sT1qzGosaGbsijpoUpxErl4ZO8Bcz4QvyLE/aV20lazJMLWFLRVYUqNKaWRxtPI4hsD+MnvBBw==',NULL,NULL,NULL,'a:0:{}','Adrian',1,'aeb@generic.com','aeb@generic.com',19,NULL,'Adrian','Esguerra','Briones','0','Approver 1','Straight','123','Filipino','2017-06-07','','','n/a','2017-09-20','n/a','n/a','n/a','n/a','n/a','n/a','n/a','n/a','2017-06-01','2017-06-01','0','',NULL,NULL,NULL,NULL,1,2,NULL),(14,NULL,'abegail34','abegail34',1,'gaaklo6ud40ksoo0o44k00cgooo8o0w','NmdEEg67rfCuRaRkpA2puwDmv4eLEtdbhBO0HjRkpYo23ql8pdAgZQS/7zwb6GXxqy/QsTHQKU7/oiklmZMmvg==',NULL,NULL,NULL,'a:0:{}','Abegail',1,'aac@generic.com','aac@generic.com',19,46,'Abegail','Atienza','Cataquiz','1','','Variable','123','Filipino','2017-07-05','234','sdf','n/a','2017-06-01','n/a','n/a','n/a','n/a','n/a','n/a','n/a','n/a','2017-06-01','2017-06-01','0','',NULL,30,NULL,NULL,1,2,''),(15,NULL,'aborre','aborre',1,'9al513gfe48wskg00c8w040gcs4kgsg','F2/TRDW2Q5oryVM98JwsAn4I4NJlK2sOvlITqzWpVizg7/ZHZxW2xUHVyNis9Co1uRnVyxuPJExBWM8GjxpLxA==',NULL,NULL,NULL,'a:0:{}','Antonio',1,'atb@generic.com','atb@generic.com',21,NULL,'Antonio','T','Borre','0','Approver 1','Straight','13','Filipino','2017-06-07','','','n/a','2017-06-01','n/a','n/a','n/a','n/a','n/a','n/a','n/a','n/a','2017-06-01','2017-06-01','0','',NULL,NULL,NULL,NULL,1,2,NULL),(16,NULL,'gaguilar','gaguilar',1,'s6c0k0k3slwssggkg8s84ko8kk0kgo8','5M3XtwSpLaWJW+yC9oDVkBy/DA/pDzVy0MmawK/Xpt+9TJGDl9oAtGc4UFX7NLS/ZIIA26w+TJKewAYiK9LAIA==',NULL,NULL,NULL,'a:0:{}','Grace',1,'gga@generic.com','gga@generic.com',22,NULL,'Grace','G','Aguilar','0','Approver 1','Straight','123','Filipino','2017-06-07','n/a','n/a','n/a','2017-06-01','n/a','n/a','n/a','n/a','n/a','n/a','n/a','n/a','2017-06-01','2017-06-01','0','',NULL,NULL,NULL,NULL,1,2,NULL),(17,NULL,'test07032017','test07032017',1,'atuvMXkQdH3jRr2snGzO0akvNSMw/kKvYEQ/h90DFwE','Ak2ISXvg1EzZ6nTwzoYsCIqeQMLPQ8l4OBM+IWge9JbGA2DrE18pFpIwTu74o7hPYwxmbaWNjVPaa71f3axUoA==',NULL,NULL,NULL,'a:0:{}','Test User 07/03/2017',1,'test07032017@test.com','test07032017@test.com',21,NULL,'Test User 07/03/2017','n/a','n/a','1','yes','Straight','n/a','Filipino','2017-07-04','n/a','n/a','n/a','2017-07-04','n/a','n/a','n/a','n/a','n/a','n/a','n/a','n/a','2017-07-04','2017-07-04','0','n/a',NULL,NULL,NULL,NULL,2,2,'432443'),(19,NULL,'000019','000019',1,'h.HgCug47tNrf.9kIylk31gaj2zN4FEn.XzAYdJ4bis','7XgYT0ZjT/fNNXVCM/a73fi9tuqpt8AuIdR3hbzDGLtRlVXEYO3lUjDzcvIVt7L/fAL5FGq/ThO0Ccno+/aAVg==',NULL,NULL,NULL,'a:0:{}','Lois',1,'lmh@generic.com','lmh@generic.com',15,NULL,'Lois','M','Halero','1','no','Straight','09657485434','Filipino','2017-07-09','Add1','Add2','Asian Life','2017-12-20','0001','0002','0003','0004','RICHARD','9786656','Cousin','N/A','2014-06-04','2020-07-16','1','',NULL,NULL,NULL,'16~1',1,2,''),(20,NULL,'000020','000020',1,'241kCLYVSwRAWPQJwQBkCbNXyfO5JmQa8rWRNESe3UA','YSSLeGgcPeQlgRWxEkNS8PkpFNvNraH10L1hyGV4rM3gdEcYayyFr9T20rCA7sX0yFi4RUcxl4lmxgAvhVnboQ==',NULL,NULL,NULL,'a:0:{}','John',1,'jke@generic.com','jke@generic.com',18,NULL,'John','K','Esguerra','1','no','Straight','09965432222','Filipino','1984-06-13','','','','2017-07-09','','','','','','','','','2017-07-09','2017-07-09','0','',NULL,NULL,NULL,NULL,1,2,'');
...
-- Dump completed on 2017-07-09 12:49:10
